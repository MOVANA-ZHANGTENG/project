 ...
 * @date 2024-11-22
 */
public interface DeviceTaskResultService   extends Service<DeviceTaskResult, Long>
{

    DeviceTaskResult getFirstState0ByTaskCode(@Param("taskCode") String taskCode);
    
    /**
     * 查询时间最早的未处理记录（state=0）
     * @return 最早的未处理记录
     */
    DeviceTaskResult getEarliestUnprocessedRecord();
