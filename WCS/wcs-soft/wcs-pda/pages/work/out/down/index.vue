...
3
 -->
				  ...
				  <div class="nameValue">
					 <div class="name" style="">备注信息:</div>
					 {{row.memo}}
				   </div>
				   <div class="nameValue">
					 <div class="name" style="">位置:</div>
					 {{row.fromCellCode}} 
					 ...
					 {{row.toCellCode}} 
					  ...
					  <div class="nameValue">
					   ...
					   <div class="nameValue">
						...
						padding: 5px;border-style: solid;border-radius: 5px;border-color:#EBEEF5;margin: 5px;"  > 
						fasdfasf
						</div>
	...
	export default {
		...
		methods: {  
			...
			getRows(){
				...
				request({ url: '/wcs-wcs/taskInfo/list', method: 'get', params: this.param }).then(response => {
					that.loading = false;
