...
import com.deer.wcs.common.core.domain.TreeSelect;
...
import com.deer.wcs.common.core.domain.model.SysDept;
...
import com.deer.wcs.framework.web.service.TokenService;
import com.deer.wcs.system.model.SysUserRole;
import com.deer.wcs.system.service.ISysDeptService;
import com.deer.wcs.system.service.ISysRoleService;
...
public class SysRoleController extends BaseController
{
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:role:query')")
    @GetMapping(value = "selectDeptTreeListByUserId")
    public Result selectDeptTreeListByUserId( )
    {
        List<TreeSelect> list =deptService.selectDeptTreeListByUserId(getUserId());
