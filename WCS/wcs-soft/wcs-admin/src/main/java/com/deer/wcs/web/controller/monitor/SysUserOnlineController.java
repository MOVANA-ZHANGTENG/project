...
import com.deer.wcs.system.model.SysUserOnline;
import com.deer.wcs.system.service.ISysUserOnlineService;
...
public class SysUserOnlineController extends BaseController
{
    ...
    public TableDataInfo list(String ipaddr, String userName)
    {
        ...
        for (String key : keys)
        {
            ...
            LoginUser user = null;
            // 处理JSONObject转换为LoginUser的情况
            if (cachedObject != null) {
                if (cachedObject instanceof LoginUser) {
                    user = (LoginUser) cachedObject;
                } else if (cachedObject instanceof com.alibaba.fastjson2.JSONObject) {
                    // 将JSONObject转换为LoginUser对象
