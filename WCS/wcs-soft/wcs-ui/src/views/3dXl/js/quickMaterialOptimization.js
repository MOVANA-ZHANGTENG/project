/**
 * 快速材质优化：在Vue组件中动态添加优化的材质应用方法
 */
function addOptimizedMaterialMethod(vueComponent) {
  vueComponent.methods.applyAllMaterials = function() {
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { addOptimizedMaterialMethod };
} else if (typeof window !== 'undefined') {
  window.addOptimizedMaterialMethod = addOptimizedMaterialMethod;
}