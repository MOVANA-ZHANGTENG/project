<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="wifi模块IP" prop="wifiModeIp">
        <el-input
    ...
    <el-table-column label="扫码点位" align="center" prop="deviceScanCodeAddress"  min-width="120">
    </el-table-column>
    <el-table-column label="是否有点位" align="center" prop="devceGuangdianAddress"  min-width="120">
    </el-table-column> -->
      ...
      <el-form ref="taskInfoForm" :model="taskInfo" :rules="taskInfoRules" label-width="80px">
        ...
        <el-form-item label="目标位置" prop="productId">
          <el-select v-model="taskInfo.toCellCode" placeholder="请选择">
            <el-option
            :disabled="item.invenState>0 || item.disableState>0|| item.taskState>0"
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="产品编码" prop="itemCode">
          <el-input v-model="form.itemCode" placeholder="请输入托盘编码" />
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
