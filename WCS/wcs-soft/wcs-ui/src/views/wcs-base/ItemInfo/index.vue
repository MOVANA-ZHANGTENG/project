  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="物料类型" prop="itemTypeCode">
        <el-select @change="getList();" v-model="queryParams.itemTypeCode" placeholder="物料类型" clearable>
          <el-option v-for="itemType in ItemTypeList" :key="itemType.code" :label="itemType.name"
            :value="itemType.code" />
        </el-select>
      </el-form-item>
      ...
      <el-form-item label="上架策略" prop="inCellTactics">
        <el-input v-model="queryParams.inCellTactics" placeholder="请输入上架策略" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="使用频率" prop="abc">
        <el-select v-model="queryParams.abc" placeholder="请选择使用频率" clearable>
          <el-option label="高频a" value="a" />
          <el-option label="中频b" value="b" />
          <el-option label="低频c" value="c" />
        </el-select>
      </el-form-item>
      <el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['wcs-base:ItemInfo:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['wcs-base:ItemInfo:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['wcs-base:ItemInfo:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['wcs-base:ItemInfo:export']">导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="ItemInfoList" @selection-change="handleSelectionChange" border>
      ...
      <el-table-column label="物料类型" align="center" prop="itemTypeName" min-width="120">
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="物料类型" prop="itemName">
          <el-select v-model="form.itemTypeCode" placeholder="物料类型" clearable>
            <el-option v-for="itemType in ItemTypeList" :key="itemType.code" :label="itemType.name"
              :value="itemType.code" />
          </el-select>
        </el-form-item>
        ...
        <el-select v-model="form.abc" placeholder="请选择使用频率" clearable>
          <el-option label="高频a" value="a" />
          <el-option label="中频b" value="b" />
          <el-option label="低频c" value="c" />
        </el-select>
...
import { listItemType } from "@/api/wcs-base/ItemType";
export default {
  name: "ItemInfo",
  data() {
    return {
  ...
  methods: {
    ...
    getItemTypeList() {
      ...
      listItemType({
        ...
        if (response.code == 200) {
          this.ItemTypeList = response.rows;
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('wcs-base/ItemInfo/export', {
        ...this.queryParams
