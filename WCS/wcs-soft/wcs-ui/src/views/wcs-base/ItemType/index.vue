<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="父级名称" prop="parentCode">
        <el-input v-model="queryParams.parentCode" placeholder="请输入父级名称" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['wcs-base:ItemType:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['wcs-base:ItemType:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['wcs-base:ItemType:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['wcs-base:ItemType:export']">导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="ItemTypeList" @selection-change="handleSelectionChange" border>
      ...
      <el-table-column label="父级ID" align="center" prop="parentId" min-width="120">
      </el-table-column>
      <el-table-column label="父级名称" align="center" prop="parentCode" min-width="120">
      </el-table-column>
      ...
      <el-table-column label="创建人名称" align="center" prop="createUserName" min-width="120">
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="父级名称" prop="parentCode">
          <el-input v-model="form.parentCode" placeholder="请输入父级名称" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除物料类型编号为"' + ids + '"的数据项？').then(function () {
        return delItemType(ids);
      }).then((response) => {
        if (response.code == 200) {
          this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('wcs-base/ItemType/export', {
        ...this.queryParams
