    ...
    u.ui.version ||
      ...
      u.fn.extend({
        ...
        zIndex: function (t) {
          ...
          if (this.length)
            for (var e, i = u(this[0]); i.length && i[0] !== document; ) {
              if (
                ("absolute" === (e = i.css("position")) ||
                  "relative" === e ||
                  "fixed" === e) &&
                ((e = parseInt(i.css("zIndex"), 10)), !isNaN(e)) &&
                0 !== e
              )
                return e;
              i = i.parent();
      ...
      _on: function (s, o, t) {
        ...
        "boolean" != typeof s && ((t = o), (o = s), (s = !1)),
          ...
          u.each(t, function (t, e) {
            ...
            var t = t.match(/^(\w+)\s*(.*)$/),
              n = t[1] + r.eventNamespace,
              t = t[2];
            t ? a.delegate(t, n, i) : o.bind(n, i);
          });
      },
      _off: function (t, e) {
        (e =
    ...
    u.each({ show: "fadeIn", hide: "fadeOut" }, function (o, a) {
      u.Widget.prototype["_" + o] = function (e, t, i) {
        ...
        (t.complete = i),
          ...
          s &&
          u.effects &&
          (u.effects.effect[n] || (!1 !== u.uiBackCompat && u.effects[n]))
            ? e[o](t)
            : n !== o && e[n]
  ...
  i(document).mouseup(function (e) {
    ...
    i.widget("ui.mouse", {
      ...
      _mouseInit: function () {
        ...
        this.element
          ...
          .bind("click." + this.widgetName, function (e) {
            if (!0 === i.data(e.target, t.widgetName + ".preventClickEvent"))
              return (
                i.removeData(e.target, t.widgetName + ".preventClickEvent"),
      ...
      _mouseMove: function (e) {
        return !i.ui.ie || 9 <= document.documentMode || e.button
          ? this._mouseStarted
...
!(function (x, o) {
  ...
  function I(t, i, e) {
    return [
      parseInt(t[0], 10) * (c.test(t[0]) ? i / 100 : 1),
      parseInt(t[1], 10) * (c.test(t[1]) ? e / 100 : 1),
    ];
  }
  function P(t, i) {
    return parseInt(x.css(t, i), 10) || 0;
  }
  (x.position = {
    ...
    getScrollInfo: function (t) {
      ...
      return {
        width: i ? x.position.scrollbarWidth() : 0,
    ...
    (x.fn.position = function (c) {
      ...
      var a,
        ...
        g,
        m = x(c.of),
        u = x.position.getWithinInfo(c.within),
        w = x.position.getScrollInfo(u),
        t = m[0],
        W = (c.collision || "flip").split(" "),
        v = {},
        y =
          9 === t.nodeType
            ? ((d = m.width()), (g = m.height()), { top: 0, left: 0 })
            : x.isWindow(t)
            ? ((d = m.width()),
              (g = m.height()),
              { top: m.scrollTop(), left: m.scrollLeft() })
            : t.preventDefault
            ? ((c.at = "left top"),
              (d = g = 0),
              { top: t.pageY, left: t.pageX })
            : ((d = m.outerWidth()), (g = m.outerHeight()), m.offset()),
        b = x.extend({}, y);
      return (
          ...
          ((e =
            1 === e.length
              ? f.test(e[0])
                ...
                ? ["center"].concat(e)
                : ["center", "center"]
              : e)[0] = f.test(e[0]) ? e[0] : "center"),
            (e[1] = r.test(e[1]) ? e[1] : "center"),
            (t = h.exec(e[0])),
            (i = h.exec(e[1])),
            (v[this] = [t ? t[0] : 0, i ? i[0] : 0]),
            (c[this] = [p.exec(e[0])[0], p.exec(e[1])[0]]);
        }),
        1 === W.length && (W[1] = W[0]),
        "right" === c.at[0]
          ? (b.left += d)
          : "center" === c.at[0] && (b.left += d / 2),
        "bottom" === c.at[1]
          ? (b.top += g)
          : "center" === c.at[1] && (b.top += g / 2),
        (a = I(v.at, d, g)),
        (b.left += a[0]),
        (b.top += a[1]),
        this.each(function () {
          var e,
            ...
            i = P(this, "marginLeft"),
            o = P(this, "marginTop"),
            l = f + i + P(this, "marginRight") + w.width,
            n = r + o + P(this, "marginBottom") + w.height,
            h = x.extend({}, b),
            p = I(v.my, s.outerWidth(), s.outerHeight());
          "right" === c.my[0]
            ? (h.left -= f)
            : "center" === c.my[0] && (h.left -= f / 2),
            "bottom" === c.my[1]
              ? (h.top -= r)
              : "center" === c.my[1] && (h.top -= r / 2),
            (h.left += p[0]),
            (h.top += p[1]),
            x.support.offsetFractions ||
              ((h.left = L(h.left)), (h.top = L(h.top))),
            (e = { marginLeft: i, marginTop: o }),
            x.each(["left", "top"], function (t, i) {
              x.ui.position[W[t]] &&
                x.ui.position[W[t]][i](h, {
                  targetWidth: d,
                  targetHeight: g,
                  elemWidth: f,
                  elemHeight: r,
              ...
              (t = function (t) {
                var i = y.left - h.left,
                  ...
                  n = {
                    ...
                    vertical: l < 0 ? "top" : 0 < o ? "bottom" : "middle",
                  };
                d < f && T(i + e) < d && (n.horizontal = "center"),
                  g < r && T(o + l) < g && (n.vertical = "middle"),
                  H(T(i), T(e)) > H(T(o), T(l))
                    ? (n.important = "horizontal")
                    : (n.important = "vertical"),
                  c.using.call(this, t, n);
              }),
            s.offset(x.extend(h, { using: t }));
        })
      );
    }),
    (x.ui.position = {
      fit: {
        left: function (t, i) {
          var e,
            ...
            o = o.width,
            n = t.left - i.collisionPosition.marginLeft,
            s = l - n,
            f = n + i.collisionWidth - o - l;
          i.collisionWidth > o
            ? 0 < s && f <= 0
              ? ((e = t.left + s + i.collisionWidth - o - l), (t.left += s - e))
              : (t.left =
                  !(0 < f && s <= 0) && f < s ? l + o - i.collisionWidth : l)
            : 0 < s
            ? (t.left += s)
            : 0 < f
            ? (t.left -= f)
            : (t.left = H(t.left - n, t.left));
        },
        top: function (t, i) {
          var e,
            o = i.within,
            ...
            l = i.within.height,
            n = t.top - i.collisionPosition.marginTop,
            s = o - n,
            f = n + i.collisionHeight - l - o;
          i.collisionHeight > l
            ? 0 < s && f <= 0
              ? ((e = t.top + s + i.collisionHeight - l - o), (t.top += s - e))
              : (t.top =
                  !(0 < f && s <= 0) && f < s ? o + l - i.collisionHeight : o)
            : 0 < s
            ? (t.top += s)
            : 0 < f
            ? (t.top -= f)
            : (t.top = H(t.top - n, t.top));
        },
      },
      flip: {
        left: function (t, i) {
          var e = i.within,
            ...
            h = -2 * i.offset[0];
          s < 0
            ? ((l = t.left + f + r + h + i.collisionWidth - l - o) < 0 ||
                l < T(s)) &&
              (t.left += f + r + h)
            : 0 < n &&
              (0 <
                (o = t.left - i.collisionPosition.marginLeft + f + r + h - e) ||
                T(o) < n) &&
              (t.left += f + r + h);
        },
        top: function (t, i) {
          var e = i.within,
            ...
            h = -2 * i.offset[1];
          s < 0
            ? ((l = t.top + f + r + h + i.collisionHeight - l - o),
              t.top + f + r + h > s &&
                (l < 0 || l < T(s)) &&
                (t.top += f + r + h))
            : 0 < n &&
              ((o = t.top - i.collisionPosition.marginTop + f + r + h - e),
              t.top + f + r + h > n) &&
              (0 < o || T(o) < n) &&
              (t.top += f + r + h);
        },
  ...
  for (t in (e &&
    x.extend(g, { position: "absolute", left: "-1000px", top: "-1000px" }),
  g))
    d.style[t] = g[t];
  d.appendChild(a),
    ...
    (a = x(a).offset().left),
    (x.support.offsetFractions = 10 < a && a < 11),
    (d.innerHTML = ""),
    e.removeChild(d),
    !1 !== x.uiBackCompat &&
      ((n = jQuery),
      ...
      (n.fn.position = function (t) {
        ...
        return t && t.offset
          ? ((i = t.offset.split(" ")),
            ...
            s.call(
              this,
              n.extend(t, { at: e[0] + i[0] + " " + e[1] + i[1], offset: o })
            ))
          : s.call(this, t);
      }));
})(jQuery);
  ...
  b.widget("ui.draggable", b.ui.mouse, {
    ...
    _mouseStop: function (t) {
      for (
        ...
        i == document && (o = !0);
      return (
        (!o && "original" === this.options.helper) ||
          (("invalid" == this.options.revert && !s) ||
          ("valid" == this.options.revert && s) ||
          !0 === this.options.revert ||
          (b.isFunction(this.options.revert) &&
            this.options.revert.call(this.element, s))
            ? b((e = this).helper).animate(
      ...
      "parent" == s.containment && (s.containment = this.helper[0].parentNode),
        ("document" != s.containment && "window" != s.containment) ||
          (this.containment = [
            ...
            ("document" == s.containment ? 0 : b(window).scrollLeft()) +
              b("document" == s.containment ? document : window).width() -
              this.helperProportions.width -
              this.margins.left,
            ("document" == s.containment ? 0 : b(window).scrollTop()) +
              (b("document" == s.containment ? document : window).height() ||
        ...
        s.containment.constructor == Array
          ...
          : (t = (s = b(s.containment))[0]) &&
            (s.offset(),
            (e = "hidden" != b(t).css("overflow")),
            (this.containment = [
              (parseInt(b(t).css("borderLeftWidth"), 10) || 0) +
                (parseInt(b(t).css("paddingLeft"), 10) || 0),
              (parseInt(b(t).css("borderTopWidth"), 10) || 0) +
                (parseInt(b(t).css("paddingTop"), 10) || 0),
              (e ? Math.max(t.scrollWidth, t.offsetWidth) : t.offsetWidth) -
                (parseInt(b(t).css("borderLeftWidth"), 10) || 0) -
                (parseInt(b(t).css("paddingRight"), 10) || 0) -
                this.helperProportions.width -
                this.margins.left -
                this.margins.right,
              (e ? Math.max(t.scrollHeight, t.offsetHeight) : t.offsetHeight) -
                (parseInt(b(t).css("borderTopWidth"), 10) || 0) -
                (parseInt(b(t).css("paddingBottom"), 10) || 0) -
                this.helperProportions.height -
                this.margins.top -
                this.margins.bottom,
            ]),
        ...
        this.originalPosition &&
          (this.containment &&
            ...
            t.pageX - this.offset.click.left < e[0] &&
              (n = e[0] + this.offset.click.left),
            t.pageY - this.offset.click.top < e[1] &&
              (r = e[1] + this.offset.click.top),
            t.pageX - this.offset.click.left > e[2] &&
              (n = e[2] + this.offset.click.left),
            t.pageY - this.offset.click.top > e[3]) &&
            (r = e[3] + this.offset.click.top),
          s.grid) &&
          ((t = s.grid[1]
            ? this.originalPageY +
    ...
    b.ui.plugin.add("draggable", "connectToSortable", {
      ...
      drag: function (i, o) {
        var n = b(this).data("draggable"),
          r = this;
        b.each(n.sortables, function (t) {
          var e = !1,
            s = this;
    ...
    b.ui.plugin.add("draggable", "cursor", {
      start: function (t, e) {
        var s = b("body"),
          i = b(this).data("draggable").options;
        s.css("cursor") && (i._cursor = s.css("cursor")),
          s.css("cursor", i.cursor);
      },
      stop: function (t, e) {
        var s = b(this).data("draggable").options;
      ...
      drag: function (t, e) {
        ...
        s.scrollParent[0] != document && "HTML" != s.scrollParent[0].tagName
          ...
          !1 !== o &&
            b.ui.ddmanager &&
            !i.dropBehaviour &&
            b.ui.ddmanager.prepareOffsets(s, t);
      },
    }),
      ...
      drag: function (t, e) {
        for (
          var s = b(this).data("draggable"),
            ...
            o = i.snapTolerance,
            n = e.offset.left,
            r = n + s.helperProportions.width,
            a = e.offset.top,
            l = a + s.helperProportions.height,
            h = s.snapElements.length - 1;
          0 <= h;
          h--
        ) {
          var c,
            ...
            d,
            g,
            u = s.snapElements[h].left,
            m = u + s.snapElements[h].width,
            v = s.snapElements[h].top,
            P = v + s.snapElements[h].height;
          (u - o < n && n < m + o && v - o < a && a < P + o) ||
          (u - o < n && n < m + o && v - o < l && l < P + o) ||
          (u - o < r && r < m + o && v - o < a && a < P + o) ||
          (u - o < r && r < m + o && v - o < l && l < P + o)
            ? ((c =
                ("inner" != i.snapMode &&
                  ((p = Math.abs(v - l) <= o),
                  (f = Math.abs(P - a) <= o),
                  ...
                  p &&
                    (e.position.top =
                      s._convertPositionTo("relative", {
                        top: v - s.helperProportions.height,
                        left: 0,
                      }).top - s.margins.top),
                  f &&
                    (e.position.top =
                  ...
                  g) &&
                  (e.position.left =
                    s._convertPositionTo("relative", { top: 0, left: m }).left -
                    s.margins.left),
                p || f || d || g)),
              "outer" != i.snapMode &&
                ((p = Math.abs(v - a) <= o),
                ...
                p &&
                  (e.position.top =
                    s._convertPositionTo("relative", { top: v, left: 0 }).top -
                    s.margins.top),
                f &&
                  (e.position.top =
                    s._convertPositionTo("relative", {
              ...
              !s.snapElements[h].snapping &&
                ...
                s.options.snap.snap.call(
                  s.element,
                  t,
                  b.extend(s._uiHash(), { snapItem: s.snapElements[h].item })
                ),
              (s.snapElements[h].snapping = p || f || d || g || c))
            : (s.snapElements[h].snapping &&
  ...
  u.widget("ui.droppable", {
    ...
    _create: function () {
      ...
      (this.isover = 0),
        ...
        (u.ui.ddmanager.droppables[e.scope] =
          u.ui.ddmanager.droppables[e.scope] || []),
        u.ui.ddmanager.droppables[e.scope].push(this),
        e.addClasses && this.element.addClass("ui-droppable");
    },
    _destroy: function () {
      for (
        var e = u.ui.ddmanager.droppables[this.options.scope], t = 0;
        t < e.length;
        t++
      )
          ...
          this.element
            ...
            .each(function () {
              ...
              if (
                ...
                u.ui.intersect(
                  s,
                  u.extend(e, { offset: e.element.offset() }),
                  e.options.tolerance
                )
              )
                return !(i = !0);
    ...
    (u.ui.intersect = function (e, t, i) {
      if (!t.offset) return !1;
      var s = (e.positionAbs || e.position.absolute).left,
        o = s + e.helperProportions.width,
        n = (e.positionAbs || e.position.absolute).top,
        r = n + e.helperProportions.height,
        a = t.offset.left,
        l = a + t.proportions.width,
        p = t.offset.top,
        h = p + t.proportions.height;
      switch (i) {
        case "fit":
          return a <= s && o <= l && p <= n && r <= h;
        case "intersect":
          return (
            a < s + e.helperProportions.width / 2 &&
            o - e.helperProportions.width / 2 < l &&
            p < n + e.helperProportions.height / 2 &&
        ...
        case "touch":
          return (
            ((p <= n && n <= h) || (p <= r && r <= h) || (n < p && h < r)) &&
            ((a <= s && s <= l) || (a <= o && o <= l) || (s < a && l < o))
          );
        default:
          return !1;
      }
    ...
    (u.ui.ddmanager = {
      ...
      prepareOffsets: function (e, t) {
        var i = u.ui.ddmanager.droppables[e.options.scope] || [],
          s = t ? t.type : null,
          o = (e.currentItem || e.element).find(":data(droppable)").andSelf();
        e: for (var n = 0; n < i.length; n++)
          if (
            !(
            ...
            (i[n].visible = "none" != i[n].element.css("display")),
              i[n].visible &&
                ("mousedown" == s && i[n]._activate.call(i[n], t),
      ...
      drop: function (e, t) {
        var i = !1;
        return (
          u.each(u.ui.ddmanager.droppables[e.options.scope] || [], function () {
            this.options &&
              (!this.options.disabled &&
                this.visible &&
                u.ui.intersect(e, this, this.options.tolerance) &&
      ...
      drag: function (o, n) {
        o.options.refreshPositions && u.ui.ddmanager.prepareOffsets(o, n),
          u.each(u.ui.ddmanager.droppables[o.options.scope] || [], function () {
            var e, t, i, s;
            this.options.disabled ||
              this.greedyChild ||
              !this.visible ||
              ((e =
                (e = u.ui.intersect(o, this, this.options.tolerance)) ||
                1 != this.isover
                  ? e && 0 == this.isover
                    ? "isover"
                    : null
                ...
                (this.options.greedy &&
                  ...
                  (s = this.element
                    ...
                    .filter(function () {
                      return u.data(this, "droppable").options.scope === i;
                    })).length) &&
                  ((t = u.data(s[0], "droppable")).greedyChild =
                    "isover" == e ? 1 : 0),
                t &&
                  "isover" == e &&
                  ((t.isover = 0), (t.isout = 1), t._out.call(t, n)),
                (this[e] = 1),
                (this["isout" == e ? "isover" : "isout"] = 0),
                this["isover" == e ? "_over" : "_out"].call(this, n),
                t) &&
                "isout" == e &&
                ((t.isout = 0), (t.isover = 1), t._over.call(t, n)));
          });
      },
...
!(function (p) {
  p.widget("ui.resizable", p.ui.mouse, {
      ...
      (this._renderAxis = function (t) {
        for (var e in ((t = t || this.element), this.handles)) {
          ...
          this.handles[e].constructor == String &&
            (this.handles[e] = p(this.handles[e], this.element).show()),
        ...
        t.autoHide &&
          ...
          p(this.element)
            ...
            .mouseenter(function () {
              t.disabled ||
                (p(this).removeClass("ui-resizable-autohide"),
                e._handles.show());
            })
            .mouseleave(function () {
              t.disabled ||
                e.resizing ||
                (p(this).addClass("ui-resizable-autohide"), e._handles.hide());
            })),
        this._mouseInit();
    },
    _destroy: function () {
    ...
    _mouseCapture: function (t) {
      var e,
        i = !1;
      for (e in this.handles) p(this.handles[e])[0] == t.target && (i = !0);
    ...
    _mouseStart: function (t) {
      var e = this.options,
        ...
        i =
          ...
          this._renderProxy(),
          r(this.helper.css("left"))),
        h = r(this.helper.css("top")),
        i =
          (e.containment &&
            ((i += p(e.containment).scrollLeft() || 0),
            (h += p(e.containment).scrollTop() || 0)),
          (this.offset = this.helper.offset()),
          (this.position = { left: i, top: h }),
          ...
          (this.originalSize = this._helper
            ? { width: s.outerWidth(), height: s.outerHeight() }
            : { width: s.width(), height: s.height() }),
          (this.originalPosition = { left: i, top: h }),
          (this.sizeDiff = {
          ...
          p(".ui-resizable-" + this.axis).css("cursor"));
      return (
        p("body").css("cursor", "auto" == i ? this.axis + "-resize" : i),
        ...
        this._helper &&
          ((i =
            (e =
              ...
              /textarea/i.test(i[0].nodeName)) && p.ui.hasScroll(i[0], "left")
              ? 0
              : n.sizeDiff.height),
          (e = e ? 0 : n.sizeDiff.width),
          (e = { width: n.helper.width() - e, height: n.helper.height() - i }),
          (i =
          ...
          h.animate || this.element.css(p.extend(e, { top: s, left: i })),
    ...
    _updateRatio: function (t, e) {
      ...
      return (
        ...
        "sw" == h && ((t.left = i.left + (s.width - t.width)), (t.top = null)),
        "nw" == h &&
    ...
    _respectSize: function (t, e) {
      ...
      var i = this._vBoundaries,
        e = (this._aspectRatio || e.shiftKey, this.axis),
        s = d(t.width) && i.maxWidth && i.maxWidth < t.width,
        h = d(t.height) && i.maxHeight && i.maxHeight < t.height,
        n = d(t.width) && i.minWidth && i.minWidth > t.width,
        o = d(t.height) && i.minHeight && i.minHeight > t.height,
        a =
    ...
    _proportionallyResize: function () {
      ...
      if (this._proportionallyResizeElements.length)
        for (
          ...
          var i,
            s,
            h = this._proportionallyResizeElements[e];
          this.borderDif ||
            ((i = [
            ...
            (this.borderDif = p.map(i, function (t, e) {
    ...
    _renderProxy: function () {
      ...
      (this.elementOffset = e.offset()),
        this._helper
          ? ((this.helper =
              this.helper || p('<div style="overflow:hidden;"></div>')),
            (e = p.ui.ie6 ? 1 : 0),
            (t = p.ui.ie6 ? 2 : -1),
            this.helper
    ...
    p.ui.plugin.add("resizable", "animate", {
      stop: function (e, t) {
        var i = p(this).data("resizable"),
          ...
          o = n && p.ui.hasScroll(h[0], "left") ? 0 : i.sizeDiff.height,
        ...
        i.element.animate(p.extend(n, a && o ? { top: a, left: o } : {}), {
          ...
          step: function () {
            ...
            h && h.length && p(h[0]).css({ width: t.width, height: t.height }),
              i._updateCache(t),
    ...
    p.ui.plugin.add("resizable", "containment", {
          ...
          /document/.test(a) || a == document
            ? ((o.containerOffset = { left: 0, top: 0 }),
              ...
              (o.parentData = {
                ...
                height:
                  p(document).height() || document.body.parentNode.scrollHeight,
              }))
            : ((i = p(l)),
              (s = []),
              p(["Top", "Right", "Left", "Bottom"]).each(function (t, e) {
                s[t] = r(i.css("padding" + e));
              }),
              ...
              (a = o.containerOffset),
              (n = o.containerSize.height),
              (h = o.containerSize.width),
              (h = p.ui.hasScroll(l, "left") ? l.scrollWidth : h),
              (n = p.ui.hasScroll(l) ? l.scrollHeight : n),
              (o.parentData = {
                element: l,
                left: a.left,
                top: a.top,
      ...
      resize: function (t, e) {
        var i = p(this).data("resizable"),
          s = i.options,
          h = (i.containerSize, i.containerOffset),
          n = (i.size, i.position),
          t = i._aspectRatio || t.shiftKey,
          o = { top: 0, left: 0 },
          a = i.containerElement,
          a =
            (a[0] != document && /static/.test(a.css("position")) && (o = h),
            n.left < (i._helper ? h.left : 0) &&
              ((i.size.width =
                i.size.width +
                (i._helper
                  ? i.position.left - h.left
                  : i.position.left - o.left)),
              t && (i.size.height = i.size.width / i.aspectRatio),
              (i.position.left = s.helper ? h.left : 0)),
            n.top < (i._helper ? h.top : 0) &&
              ((i.size.height =
                i.size.height +
                (i._helper ? i.position.top - h.top : i.position.top)),
              t && (i.size.width = i.size.height * i.aspectRatio),
              (i.position.top = i._helper ? h.top : 0)),
            (i.offset.left = i.parentData.left + i.position.left),
            (i.offset.top = i.parentData.top + i.position.top),
            Math.abs((i._helper, i.offset.left - o.left + i.sizeDiff.width))),
          s = Math.abs(
            (i._helper ? i.offset.top - o.top : i.offset.top - h.top) +
              i.sizeDiff.height
          ),
          n = i.containerElement.get(0) == i.element.parent().get(0),
          o = /relative|absolute/.test(i.containerElement.css("position"));
        n && o && (a -= i.parentData.left),
          a + i.size.width >= i.parentData.width &&
            ((i.size.width = i.parentData.width - a), t) &&
            (i.size.height = i.size.width / i.aspectRatio),
          s + i.size.height >= i.parentData.height &&
            ((i.size.height = i.parentData.height - s), t) &&
            (i.size.width = i.size.height * i.aspectRatio);
      },
      stop: function (t, e) {
        var i = p(this).data("resizable"),
          s = i.options,
          h = (i.position, i.containerOffset),
          n = i.containerPosition,
          o = i.containerElement,
          a = p(i.helper),
          l = a.offset(),
          r = a.outerWidth() - i.sizeDiff.width,
          a = a.outerHeight() - i.sizeDiff.height;
        i._helper &&
          !s.animate &&
          /relative/.test(o.css("position")) &&
          p(this).css({ left: l.left - n.left - h.left, width: r, height: a }),
          i._helper &&
            !s.animate &&
            /static/.test(o.css("position")) &&
            p(this).css({
              left: l.left - n.left - h.left,
              width: r,
              height: a,
            });
      },
      ...
      resize: function (t, e) {
        var i = p(this).data("resizable"),
          ...
          t =
            ...
            Math.round((h.width - n.width) / (s.grid[0] || 1)) *
              (s.grid[0] || 1)),
          h =
            Math.round((h.height - n.height) / (s.grid[1] || 1)) *
            (s.grid[1] || 1);
        /^(se|s|e)$/.test(a)
          ? ((i.size.width = n.width + t), (i.size.height = n.height + h))
          : /^(ne)$/.test(a)
          ? ((i.size.width = n.width + t),
            (i.size.height = n.height + h),
    ...
    _create: function () {
      ...
      this.element.addClass("ui-selectable"),
        ...
        (this.refresh = function () {
          (e = u(t.options.filter, t.element[0])).addClass("ui-selectee"),
            e.each(function () {
              var e = u(this),
                t = e.offset();
        ...
        this._mouseInit(),
        (this.helper = u("<div class='ui-selectable-helper'></div>"));
    },
    _destroy: function () {
    ...
    _mouseDrag: function (s) {
      ...
      if (((this.dragged = !0), !this.options.disabled))
        return (
          ...
          i < n && ((e = i), (i = n), (n = e)),
          c < a && ((e = c), (c = a), (a = e)),
          this.helper.css({ left: n, top: a, width: i - n, height: c - a }),
          this.selectees.each(function () {
            var e,
              t = u.data(this, "selectable-item");
            t &&
              t.element != r.element[0] &&
              ((e = !1),
              "touch" == l.tolerance
                ? (e = !(
                    t.left > i ||
                ...
                : "fit" == l.tolerance &&
                  (e = t.left > n && t.right < i && t.top > a && t.bottom < c),
              e
                ? (t.selected &&
                    (t.$element.removeClass("ui-selected"), (t.selected = !1)),
                  t.unselecting &&
                  ...
                  t.selecting ||
                    ...
                    (t.selecting = !0),
                    r._trigger("selecting", s, { selecting: t.element })))
                : (t.selecting &&
                  ...
                  !t.selected ||
                    ...
                    t.$element.addClass("ui-unselecting"),
                    (t.unselecting = !0),
                    r._trigger("unselecting", s, { unselecting: t.element }))));
          }),
          !1
        );
    },
  ...
  f.widget("ui.sortable", f.ui.mouse, {
    ...
    _mouseCapture: function (t, e) {
      ...
      f(t.target)
        .parents()
        .each(function () {
          if (f.data(this, i.widgetName + "-item") == i)
            return (s = f(this)), !1;
        });
      if (
        !(s = f.data(t.target, i.widgetName + "-item") == i ? f(t.target) : s)
      )
        return !1;
      if (this.options.handle && !e) {
        var o = !1;
        if (
          (f(this.options.handle, s)
            .find("*")
            .andSelf()
            .each(function () {
              this == t.target && (o = !0);
    ...
    _mouseStart: function (t, e, i) {
      ...
      if (
        ...
        s.cursor &&
          (f("body").css("cursor") &&
            (this._storedCursor = f("body").css("cursor")),
          f("body").css("cursor", s.cursor)),
        s.opacity &&
        ...
        for (var o = this.containers.length - 1; 0 <= o; o--)
          this.containers[o]._trigger("activate", t, this._uiHash(this));
      return (
        f.ui.ddmanager && (f.ui.ddmanager.current = this),
        f.ui.ddmanager &&
          !s.dropBehaviour &&
    ...
    _mouseDrag: function (t) {
            ...
            ? (this.overflowOffset.top +
              ...
              e.scrollSensitivity
                ...
                : t.pageX - this.overflowOffset.left < e.scrollSensitivity &&
                  (this.scrollParent[0].scrollLeft = i =
                    this.scrollParent[0].scrollLeft - e.scrollSpeed))
            : (t.pageY - f(document).scrollTop() < e.scrollSensitivity
                ? (i = f(document).scrollTop(
                    f(document).scrollTop() - e.scrollSpeed
                  ))
                : f(window).height() - (t.pageY - f(document).scrollTop()) <
                    e.scrollSensitivity &&
                  (i = f(document).scrollTop(
                    f(document).scrollTop() + e.scrollSpeed
                  )),
              t.pageX - f(document).scrollLeft() < e.scrollSensitivity
                ? (i = f(document).scrollLeft(
                    f(document).scrollLeft() - e.scrollSpeed
                  ))
                : f(window).width() - (t.pageX - f(document).scrollLeft()) <
                    e.scrollSensitivity &&
                  (i = f(document).scrollLeft(
                    f(document).scrollLeft() + e.scrollSpeed
                  ))),
      ...
      for (var s = this.items.length - 1; 0 <= s; s--) {
        ...
        if (
          ...
          !(
            ...
            this.placeholder[1 == n ? "next" : "prev"]()[0] == r ||
            f.contains(this.placeholder[0], r) ||
            ("semi-dynamic" == this.options.type &&
              f.contains(this.element[0], r))
          )
        ) {
          if (
      ...
      return (
        ...
        f.ui.ddmanager && f.ui.ddmanager.drag(this, t),
    ...
    _mouseStop: function (t, e) {
      ...
      if (t)
        return (
          f.ui.ddmanager &&
            !this.options.dropBehaviour &&
            f.ui.ddmanager.drop(this, t),
          this.options.revert
            ? ((s = (i = this).placeholder.offset()),
              (this.reverting = !0),
              f(this.helper).animate(
                {
                  left:
                    s.left -
                    this.offset.parent.left -
    ...
    serialize: function (e) {
      ...
      return (
        (e = e || {}),
        f(t).each(function () {
          var t = (f(e.item || this).attr(e.attribute || "id") || "").match(
            e.expression || /(.+)[-=_](.+)/
          );
          t &&
            i.push(
    ...
    _getItemsAsjQuery: function (t) {
      ...
      if (s && t)
        for (var o = s.length - 1; 0 <= o; o--)
          for (var r = f(s[o]), n = r.length - 1; 0 <= n; n--) {
            var h = f.data(r[n], this.widgetName);
            h &&
              h != this &&
              !h.options.disabled &&
              i.push([
                f.isFunction(h.options.items)
                  ? h.options.items.call(h.element)
                  : f(h.options.items, h.element)
      ...
      i.push([
        f.isFunction(this.options.items)
          ? this.options.items.call(this.element, null, {
              options: this.options,
              item: this.currentItem,
            })
          : f(this.options.items, this.element)
              .not(".ui-sortable-helper")
              .not(".ui-sortable-placeholder"),
        this,
      ]);
    ...
    _refreshItems: function (t) {
        ...
        for (var o = s.length - 1; 0 <= o; o--)
          for (var r = f(s[o]), n = r.length - 1; 0 <= n; n--) {
            ...
            h &&
              ...
              (i.push([
                f.isFunction(h.options.items)
                  ? h.options.items.call(h.element[0], t, {
                      item: this.currentItem,
                    })
                  : f(h.options.items, h.element),
                h,
      ...
      for (o = i.length - 1; 0 <= o; o--)
        for (var a = i[o][1], l = i[o][0], n = 0, c = l.length; n < c; n++) {
          var p = f(l[n]);
          p.data(this.widgetName + "-item", a),
            e.push({
              item: p,
              instance: a,
              width: 0,
    ...
    refreshPositions: function (t) {
      ...
      for (var e = this.items.length - 1; 0 <= e; e--) {
        ...
        (s.instance != this.currentContainer &&
          ...
          ((i = this.options.toleranceElement
            ? f(this.options.toleranceElement, s.item)
            : s.item),
      ...
      if (this.options.custom && this.options.custom.refreshContainers)
        ...
        for (e = this.containers.length - 1; 0 <= e; e--) {
          var o = this.containers[e].element.offset();
    ...
    _createPlaceholder: function (i) {
      ...
      (o.placeholder && o.placeholder.constructor != String) ||
        ...
        (o.placeholder = {
          element: function () {
            var t = f(document.createElement(i.currentItem[0].nodeName))
              .addClass(
    ...
    _contactContainers: function (t) {
      for (var e = null, i = null, s = this.containers.length - 1; 0 <= s; s--)
        f.contains(this.currentItem[0], this.containers[s].element[0]) ||
          (this._intersectsWith(this.containers[s].containerCache)
            ? (e && f.contains(this.containers[s].element[0], e.element[0])) ||
      ...
      if (e)
        if (1 === this.containers.length)
          ...
          for (
            ...
            f.contains(this.containers[i].element[0], this.items[p].item[0]) &&
              this.items[p].item[0] != this.currentItem[0] &&
              ((o = this.items[p].item.offset()[a]),
              (r = !1),
              Math.abs(o - c) > Math.abs(o + this.items[p][l] - c) &&
                ((r = !0), (o += this.items[p][l])),
              Math.abs(o - c) < n) &&
              ((n = Math.abs(o - c)),
              (h = this.items[p]),
              (this.direction = r ? "up" : "down"));
          (h || this.options.dropOnEmpty) &&
            ((this.currentContainer = this.containers[i]),
            h
              ? this._rearrange(t, h, null, !0)
    ...
    _createHelper: function (t) {
      var e = this.options,
        t = f.isFunction(e.helper)
          ? f(e.helper.apply(this.element[0], [t, this.currentItem]))
          : "clone" == e.helper
    ...
    _adjustOffsetFromHelper: function (t) {
      "string" == typeof t && (t = t.split(" ")),
        "left" in (t = f.isArray(t) ? { left: +t[0], top: +t[1] || 0 } : t) &&
          (this.offset.click.left = t.left + this.margins.left),
        "right" in t &&
          (this.offset.click.left =
            this.helperProportions.width - t.right + this.margins.left),
    ...
    _getParentOffset: function () {
      ...
      return (
        "absolute" == this.cssPosition &&
          this.scrollParent[0] != document &&
          f.contains(this.scrollParent[0], this.offsetParent[0]) &&
          ((t.left += this.scrollParent.scrollLeft()),
          (t.top += this.scrollParent.scrollTop())),
        {
          top:
      ...
      "parent" == i.containment && (i.containment = this.helper[0].parentNode),
        ("document" != i.containment && "window" != i.containment) ||
          (this.containment = [
            ...
            f("document" == i.containment ? document : window).width() -
              this.helperProportions.width -
              this.margins.left,
            (f("document" == i.containment ? document : window).height() ||
              document.body.parentNode.scrollHeight) -
              this.helperProportions.height -
              this.margins.top,
          ]),
        /^(document|window|parent)$/.test(i.containment) ||
          ((t = f(i.containment)[0]),
          (i = f(i.containment).offset()),
          (e = "hidden" != f(t).css("overflow")),
          (this.containment = [
            i.left +
              (parseInt(f(t).css("borderLeftWidth"), 10) || 0) +
              (parseInt(f(t).css("paddingLeft"), 10) || 0) -
              this.margins.left,
            i.top +
              (parseInt(f(t).css("borderTopWidth"), 10) || 0) +
              (parseInt(f(t).css("paddingTop"), 10) || 0) -
              this.margins.top,
            i.left +
              (e ? Math.max(t.scrollWidth, t.offsetWidth) : t.offsetWidth) -
              (parseInt(f(t).css("borderLeftWidth"), 10) || 0) -
              (parseInt(f(t).css("paddingRight"), 10) || 0) -
              this.helperProportions.width -
              this.margins.left,
            i.top +
              (e ? Math.max(t.scrollHeight, t.offsetHeight) : t.offsetHeight) -
              (parseInt(f(t).css("borderTopWidth"), 10) || 0) -
              (parseInt(f(t).css("paddingBottom"), 10) || 0) -
              this.helperProportions.height -
              this.margins.top,
          ]));
    },
    ...
    _generatePosition: function (t) {
      ...
      return (
        this.originalPosition &&
          ...
          ((t =
            this.originalPageY +
            Math.round((r - this.originalPageY) / e.grid[1]) * e.grid[1]),
          (r =
            this.containment &&
      ...
      for (s = this.containers.length - 1; 0 <= s; s--)
        e ||
          ...
          this.containers[s].containerCache.over &&
            ...
            (this.containers[s].containerCache.over = 0));
      if (
        (this._storedCursor && f("body").css("cursor", this._storedCursor),
    ...
    _trigger: function () {
      !1 === f.Widget.prototype._trigger.apply(this, arguments) &&
        this.cancel();
    },
    _uiHash: function (t) {
      var e = t || this;
...
!(function (c) {
  ...
  (u.height =
    ...
    c.widget("ui.accordion", {
      ...
      _create: function () {
        var o = (this.accordionId =
            "ui-accordion-" + (this.element.attr("id") || ++l)),
          e = this.options;
          ...
          this.headers
            ...
            .each(function (e) {
              var t = c(this),
                ...
                a = t.next(),
                n = a.attr("id");
              i || t.attr("id", (i = o + "-header-" + e)),
                n || a.attr("id", (n = o + "-panel-" + e)),
      ...
      _keydown: function (e) {
        if (!e.altKey && !e.ctrlKey) {
          ...
          switch (e.keyCode) {
            case t.RIGHT:
            case t.DOWN:
              n = this.headers[(a + 1) % i];
              break;
            case t.LEFT:
            case t.UP:
              n = this.headers[(a - 1 + i) % i];
              break;
            case t.SPACE:
            case t.ENTER:
      ...
      _panelKeyDown: function (e) {
        e.keyCode === c.ui.keyCode.UP &&
          e.ctrlKey &&
          c(e.currentTarget).prev().focus();
      },
      refresh: function () {
        var i,
          e,
          t = this.options.heightStyle,
          a = this.element.parent();
        "fill" === t
          ? (c.support.minHeight ||
              ((e = a.css("overflow")), a.css("overflow", "hidden")),
            (i = a.height()),
      ...
      _eventHandler: function (e) {
        ...
        e.preventDefault(),
          (n && !t.collapsible) ||
            ...
            ((t.active = !o && this.headers.index(a)),
            (this.active = n ? c() : a),
            this._toggle(s),
      ...
      _animate: function (e, i, t) {
        ...
        var n,
          o = this,
          r = 0,
          s = e.length && (!i.length || e.index() < i.index()),
          c = this.options.animate || {},
          s = (s && c.down) || c,
          h = (h = "string" == typeof s ? s : h) || s.easing || c.easing,
          d = (d = "number" == typeof s ? s : d) || s.duration || c.duration;
        return i.length
          ? e.length
    ...
    !1 !== c.uiBackCompat &&
      ((s = jQuery),
      (h = jQuery.ui.accordion.prototype),
      s.extend(h.options, {
        navigation: !1,
      ...
      (h._create = function () {
        ...
        this.options.navigation &&
          ((i = (e = (t = this).element.find(this.options.header)).next()),
          (a = e.add(i).find("a").filter(this.options.navigationFilter)[0])) &&
          e.add(i).each(function (e) {
            if (s.contains(this, a))
              return (t.options.active = Math.floor(e / 2)), !1;
          }),
          d.call(this);
      }),
      (h = jQuery),
      (a = jQuery.ui.accordion.prototype),
      h.extend(a.options, {
        heightStyle: null,
        autoHeight: !0,
        clearStyle: !1,
      ...
      jQuery,
      ((h = jQuery.ui.accordion.prototype).activate = h._activate),
      (i = h._findActive),
      (h._findActive = function (e) {
        return (
          (e = -1 === e ? !1 : e) &&
            "number" != typeof e &&
            -1 === (e = this.headers.index(this.headers.filter(e))) &&
            (e = !1),
          i.call(this, e)
        );
      }),
      ...
      (a = jQuery),
      (h = jQuery.ui.accordion.prototype),
      a.extend(h.options, { change: null, changestart: null }),
      (n = h._trigger),
      (h._trigger = function (e, t, i) {
        var a = n.apply(this, arguments);
        return (
          !!a &&
          ("beforeActivate" === e
            ? (a = n.call(this, "changestart", t, {
      ...
      (a = jQuery),
      (h = jQuery.ui.accordion.prototype),
      a.extend(h.options, { animate: null, animated: "slide" }),
      (t = h._create),
      (h._create = function () {
        var e = this.options;
        null === e.animate &&
  ...
  o.widget("ui.autocomplete", {
          ...
          menufocus: function (e, t) {
            ...
            /^mouse/.test(e.originalEvent.type)
              ...
              : ((t =
                ...
                !1 !== this._trigger("focus", e, { item: t })
                  ? e.originalEvent &&
    ...
    _isMultiLine: function () {
      return (
        ...
        (!this.element.is("input") && this.element.prop("isContentEditable"))
      );
    },
  ...
  o.widget("ui.button", {
        ...
        t &&
          ...
          this.buttonElement
            .bind("mousedown" + this.eventNamespace, function (t) {
              i.disabled || ((h = !1), (r = t.pageX), (d = t.pageY));
            })
            .bind("mouseup" + this.eventNamespace, function (t) {
              i.disabled || (r === t.pageX && d === t.pageY) || (h = !0);
            })),
        "checkbox" === this.type
    ...
    _destroy: function () {
      this.element.removeClass("ui-helper-hidden-accessible"),
        this.buttonElement
          .removeClass(c + " ui-state-hover ui-state-active  " + b)
          .removeAttr("role")
    ...
    _resetButton: function () {
      ...
      "input" === this.type
        ...
        : ((t = this.buttonElement.removeClass(b)),
...
!(function ($, undefined) {
    ...
    return e
      ...
      .delegate(t, "mouseover", function () {
        $.datepicker._isDisabledDatepicker(
          (instActive.inline ? e.parent() : instActive.input)[0]
        ) ||
          ($(this)
  ...
  function extendRemove(e, t) {
    for (var a in ($.extend(e, t), t))
      (null != t[a] && t[a] != undefined) || (e[a] = t[a]);
  }
  $.extend(Datepicker.prototype, {
      ...
      (i.append = $([])),
        ...
        t.hasClass(this.markerClassName) ||
          ...
          t
            ...
            .keyup(this._doKeyUp)
            .bind("setData.datepicker", function (e, t, a) {
              i.settings[t] = a;
            })
          ...
          (t.trigger = $(
            this._get(t, "buttonImageOnly")
              ...
              : $('<button type="button"></button>')
                  .addClass(this._triggerClass)
                  .html(
                    "" == a ? i : $("<img/>").attr({ src: a, alt: i, title: i })
                  )
          )),
    ...
    _autoSize: function (e) {
      ...
      this._get(e, "autoSize") &&
        ...
        (a = this._get(e, "dateFormat")).match(/[DM]/) &&
          (t.setMonth(
            (i = function (e) {
              for (var t = 0, a = 0, i = 0; i < e.length; i++)
                e[i].length > t && ((t = e[i].length), (a = i));
              return a;
            })(this._get(e, a.match(/MM/) ? "monthNames" : "monthNamesShort"))
          ),
          t.setDate(
            i(this._get(e, a.match(/DD/) ? "dayNames" : "dayNamesShort")) +
              20 -
              t.getDay()
          )),
    ...
    _optionDatepicker: function (e, t, a) {
      ...
      "string" == typeof t && ((d = {})[t] = a),
        i &&
          ...
          (r = this._getMinMaxDate(i, "max")),
          extendRemove(i.settings, d),
          null !== n &&
            d.dateFormat !== undefined &&
            d.minDate === undefined &&
            (i.settings.minDate = this._formatDate(i, n)),
          null !== r &&
            d.dateFormat !== undefined &&
            d.maxDate === undefined &&
            (i.settings.maxDate = this._formatDate(i, r)),
          ...
          case 13:
            var s,
              ...
              n =
                ...
                $.datepicker._get(t, "onSelect"));
            return (
              n
                ? ((s = $.datepicker._formatDate(t)),
    ...
    _doKeyPress: function (e) {
      var t,
        a = $.datepicker._getInst(e.target);
      if ($.datepicker._get(a, "constrainInput"))
        return (
          (a = $.datepicker._possibleChars($.datepicker._get(a, "dateFormat"))),
    ...
    _doKeyUp: function (e) {
      e = $.datepicker._getInst(e.target);
    ...
    _showDatepicker: function (e) {
      ...
      "input" != (e = e.target || e).nodeName.toLowerCase() &&
        ...
        $.datepicker._isDisabledDatepicker(e) ||
          ...
          ((a = $.datepicker._getInst(e)),
          $.datepicker._curInst &&
            $.datepicker._curInst != a &&
            ($.datepicker._curInst.dpDiv.stop(!0, !0), a) &&
            $.datepicker._datepickerShowing &&
            $.datepicker._hideDatepicker($.datepicker._curInst.input[0]),
          !1 ===
            (i = (i = $.datepicker._get(a, "beforeShow"))
              ? i.apply(e, [e, a])
              : {})) ||
          (extendRemove(a.settings, i),
          (a.lastVal = null),
          ($.datepicker._lastInput = e),
          ...
          $(e)
            .parents()
            .each(function () {
              return !(t |= "fixed" == $(this).css("position"));
            }),
          (i = { left: $.datepicker._pos[0], top: $.datepicker._pos[1] }),
          ...
          (i = $.datepicker._checkOffset(a, i, t)),
          a.dpDiv.css({
            position:
          ...
          a.inline) ||
          ((i = $.datepicker._get(a, "showAnim")),
          (s = $.datepicker._get(a, "duration")),
          (n = function () {
            var e,
              t = a.dpDiv.find("iframe.ui-datepicker-cover");
            t.length &&
              ((e = $.datepicker._getBorders(a.dpDiv)),
              t.css({
                left: -e[0],
                top: -e[1],
          ...
          a.dpDiv.zIndex($(e).zIndex() + 1),
          ($.datepicker._datepickerShowing = !0),
          $.effects && ($.effects.effect[i] || $.effects[i])
            ? a.dpDiv.show(i, $.datepicker._get(a, "showOptions"), s, n)
            : a.dpDiv[i || "show"](i ? s : null, n),
          (i && s) || n(),
          a.input.is(":visible") && !a.input.is(":disabled") && a.input.focus(),
          ($.datepicker._curInst = a));
    },
    _updateDatepicker: function (e) {
      ...
      var t,
        ...
        i =
          ...
          e.dpDiv.find("iframe.ui-datepicker-cover")),
        i =
          (i.length &&
            i.css({
              left: -a[0],
    ...
    _checkOffset: function (e, t, a) {
      ...
      return (
        (t.left -= this._get(e, "isRTL") ? i - n : 0),
        (t.left -=
          a && t.left == e.input.offset().left ? $(document).scrollLeft() : 0),
        (t.top -=
          a && t.top == e.input.offset().top + r ? $(document).scrollTop() : 0),
        (t.left -= Math.min(
          t.left,
      ...
      !i ||
        ...
        (this._datepickerShowing &&
          ...
          $.effects && ($.effects.effect[e] || $.effects[e])
            ? i.dpDiv.hide(e, $.datepicker._get(i, "showOptions"), a, t)
            : i.dpDiv[
                "slideDown" == e
                  ? "slideUp"
                  : "fadeIn" == e
    ...
    _adjustDate: function (e, t, a) {
      ...
      this._isDisabledDatepicker(e[0]) ||
        (this._adjustInstDate(
          i,
          t + ("M" == a ? this._get(i, "showCurrentAtPos") : 0),
          a
        ),
        this._updateDatepicker(i));
    },
    ...
    iso8601Week: function (e) {
      var e = new Date(e.getTime()),
        t = (e.setDate(e.getDate() + 4 - (e.getDay() || 7)), e.getTime());
      return (
        e.setMonth(0),
        e.setDate(1),
    ...
    parseDate: function (t, s, e) {
      ...
      function i(e, t, a) {
        ...
        if (
          ($.each(e, function (e, t) {
            var a = t[1];
            if (s.substr(m, a.length).toLowerCase() == a.toLowerCase())
              return (i = t[0]), (m += a.length), !1;
          }),
          -1 != i)
        )
          return i + 1;
      ...
      if (
        ...
        for (h = 1, p = g; ; ) {
          var y = this._getDaysInMonth(u, h - 1);
          if (p <= y) break;
          h++, (p -= y);
        }
      if (
        (D = this._daylightSavingAdjust(new Date(u, h - 1, p))).getFullYear() !=
          u ||
        D.getMonth() + 1 != h ||
        D.getDate() != p
      )
    ...
    formatDate: function (t, e, a) {
      ...
      var n = (a ? a.dayNamesShort : null) || this._defaults.dayNamesShort,
      ...
      if (e)
        for (var h = 0; h < t.length; h++)
          if (u) "'" != t.charAt(h) || c("'") ? (l += t.charAt(h)) : (u = !1);
          else
            switch (t.charAt(h)) {
              case "d":
                l += i("d", e.getDate(), 2);
            ...
            ? (function (e) {
                try {
                  return $.datepicker.parseDate(
                    $.datepicker._get(d, "dateFormat"),
                    e,
                    $.datepicker._getFormatConfig(d)
                  );
                } catch (e) {}
                for (
                  var t =
                      (e.toLowerCase().match(/^c/)
                        ? $.datepicker._getDate(d)
                        : null) || new Date(),
                    a = t.getFullYear(),
                    i = t.getMonth(),
                    s = t.getDate(),
                  ...
                  switch (r[2] || "d") {
                    ...
                    case "M":
                      (i += parseInt(r[1], 10)),
                        (s = Math.min(s, $.datepicker._getDaysInMonth(a, i)));
                      break;
                    case "y":
                    case "Y":
                      (a += parseInt(r[1], 10)),
      ...
      if ((h < 0 && ((h += 12), p--), u))
        for (
          var g = this._daylightSavingAdjust(
              new Date(
                u.getFullYear(),
                u.getMonth() - n[0] * n[1] + 1,
                u.getDate()
              )
            ),
            g = l && g < l ? l : g;
          this._daylightSavingAdjust(new Date(p, h, 1)) > g;

        )
          --h < 0 && ((h = 11), p--);
      (e.drawMonth = h), (e.drawYear = p);
      for (
        var r = this._get(e, "prevText"),
          r = s
            ? this.formatDate(
                r,
                this._daylightSavingAdjust(new Date(p, h - d, 1)),
                this._getFormatConfig(e)
              )
            : r,
          _ = this._canAdjustMonth(e, -1, p, h)
          ...
          r = s
            ...
            : r,
          f = this._canAdjustMonth(e, 1, p, h)
          ...
          i = this._get(e, "gotoCurrent") && e.currentDay ? c : t,
          d = s ? this.formatDate(d, i, this._getFormatConfig(e)) : d,
          r = e.inline
            ? ""
          ...
          m = isNaN(m) ? 0 : m,
          k = this._get(e, "showWeek"),
          P = this._get(e, "dayNames"),
          R = (this._get(e, "dayNamesShort"), this._get(e, "dayNamesMin")),
        ...
        this.maxRows = 4;
        for (var C = 0; C < n[1]; C++) {
          var I = this._daylightSavingAdjust(new Date(p, h, e.selectedDay)),
            x = " ui-corner-all",
            N = "";
          if (o) {
            if (((N += '<div class="ui-datepicker-group'), 1 < n[1]))
              switch (C) {
                case 0:
                ...
                case n[1] - 1:
                  ...
                  break;
                default:
                  (N += " ui-datepicker-group-middle"), (x = "");
              }
            N += '">';
          }
          N +=
            ...
            x +
            '">' +
            (/all|left/.test(x) && 0 == w ? (a ? f : _) : "") +
            (/all|right/.test(x) && 0 == w ? (a ? _ : f) : "") +
            this._generateMonthYearHeader(e, h, p, l, u, 0 < w || 0 < C, E, W) +
          ...
          for (
            ...
            S +=
              "<th" +
              (5 <= (Y + m + 6) % 7 ? ' class="ui-datepicker-week-end"' : "") +
              '><span title="' +
              P[L] +
              '">' +
              R[L] +
          ...
          N += S + "</tr></thead><tbody>";
          for (
            var A = this._getDaysInMonth(p, h),
              z =
                (p == e.selectedYear &&
                  h == e.selectedMonth &&
                  (e.selectedDay = Math.min(e.selectedDay, A)),
                (this._getFirstDayOfMonth(p, h) - m + 7) % 7),
              A = Math.ceil((z + A) / 7),
              U = o && this.maxRows > A ? this.maxRows : A,
              F =
                ((this.maxRows = U),
                this._daylightSavingAdjust(new Date(p, h, 1 - z))),
              B = 0;
            B < U;
            B++
          ) {
            ...
            for (
              ...
              var T = D ? D.apply(e.input ? e.input[0] : null, [F]) : [!0, ""],
                j = F.getMonth() != h,
                O = (j && !H) || !T[0] || (l && F < l) || (u && u < F);
              (Q +=
                '<td class="' +
                (5 <= (Y + m + 6) % 7 ? " ui-datepicker-week-end" : "") +
                (j ? " ui-datepicker-other-month" : "") +
                ((F.getTime() == I.getTime() &&
                  h == e.selectedMonth &&
                  e._keyEvent) ||
                (v.getTime() == F.getTime() && v.getTime() == I.getTime())
                  ? " " + this._dayOverClass
                  : "") +
                (O
                ...
                (j && !y
                  ...
                  : '<a class="ui-state-default' +
                    (F.getTime() == t.getTime() ? " ui-state-highlight" : "") +
                    (F.getTime() == c.getTime() ? " ui-state-active" : "") +
    ...
    _generateMonthYearHeader: function (e, t, a, i, s, n, r, d) {
      var o = this._get(e, "changeMonth"),
        ...
        h = "";
      if (n || !o) h += '<span class="ui-datepicker-month">' + r[t] + "</span>";
      else {
        ...
        for (var _ = 0; _ < 12; _++)
          (!p || _ >= i.getMonth()) &&
            ...
            (h +=
              ...
              _ +
              '"' +
              (_ == t ? ' selected="selected"' : "") +
              ">" +
              d[_] +
              "</option>");
        h += "</select>";
      }
      if ((l || (u += h + (!n && o && c ? "" : "&#xa0;")), !e.yearshtml))
        if (((e.yearshtml = ""), n || !c))
          u += '<span class="ui-datepicker-year">' + a + "</span>";
        else {
          function f(e) {
            e = e.match(/c[+-].*/)
          ...
          var r = this._get(e, "yearRange").split(":"),
            m = new Date().getFullYear(),
            k = f(r[0]),
            D = Math.max(k, f(r[1] || "")),
            k = i ? Math.max(k, i.getFullYear()) : k,
            D = s ? Math.min(D, s.getFullYear()) : D;
          for (
            e.yearshtml +=
    ...
    _isInRange: function (e, t) {
      var a = this._getMinMaxDate(e, "min"),
        e = this._getMinMaxDate(e, "max");
      return (
        (!a || t.getTime() >= a.getTime()) && (!e || t.getTime() <= e.getTime())
      );
    },
  ...
  l.widget("ui.dialog", {
    ...
    _create: function () {
      ...
      var i,
        ...
        s = this.options,
        n = s.title || "&#160;",
        a = (this.uiDialog = l("<div>"))
          .addClass(h + s.dialogClass)
          .css({ display: "none", outline: 0, zIndex: s.zIndex })
          .attr("tabIndex", -1)
          .keydown(function (i) {
            s.closeOnEscape &&
      ...
      this.element
        ...
        (t = l("<a href='#'></a>")
          ...
          .attr("role", "button")
          .click(function (i) {
            i.preventDefault(), o.close(i);
          })
          .appendTo(i)),
        (this.uiDialogTitlebarCloseText = l("<span>"))
        ...
        (n = l("<span>")
          ...
          .html(n)
          .prependTo(i)),
        (e = (this.uiDialogButtonPane = l("<div>")).addClass(
          "ui-dialog-buttonpane ui-widget-content ui-helper-clearfix"
        )),
        (this.uiButtonSet = l("<div>"))
          .addClass("ui-dialog-buttonset")
          .appendTo(e),
        a.attr({ role: "dialog", "aria-labelledby": n.attr("id") }),
        i.find("*").add(i).disableSelection(),
        this._hoverable(t),
        this._focusable(t),
        s.draggable && l.fn.draggable && this._makeDraggable(),
        s.resizable && l.fn.resizable && this._makeResizable(),
        this._createButtons(s.buttons),
        (this._isOpen = !1),
        l.fn.bgiframe && a.bgiframe(),
        this._on(a, {
          keydown: function (i) {
            var t, e;
            if (s.modal && i.keyCode === l.ui.keyCode.TAB)
              return (
                (t = (e = l(":tabbable", a)).filter(":first")),
                (e = e.filter(":last")),
                i.target !== e[0] || i.shiftKey
                  ? i.target === t[0] && i.shiftKey
                    ? (e.focus(1), !1)
                    : void 0
                  : (t.focus(1), !1)
              );
    ...
    close: function (i) {
      var t,
        e,
        o = this;
      if (this._isOpen && !1 !== this._trigger("beforeClose", i))
        return (
          (this._isOpen = !1),
          this.overlay && this.overlay.destroy(),
          this.options.hide
            ...
            : (this.uiDialog.hide(), this._trigger("close", i)),
          l.ui.dialog.overlay.resize(),
          this.options.modal &&
            ((t = 0),
            l(".ui-dialog").each(function () {
              this !== o.uiDialog[0] &&
                ((e = l(this).css("z-index")),
                isNaN(e) || (t = Math.max(t, e)));
            }),
            (l.ui.dialog.maxZ = t)),
          this
        );
    ...
    moveToTop: function (i, t) {
      var e = this.options;
      return (e.modal && !i) || (!e.stack && !e.modal)
        ? this._trigger("focus", t)
        : (e.zIndex > l.ui.dialog.maxZ && (l.ui.dialog.maxZ = e.zIndex),
          this.overlay &&
            ((l.ui.dialog.maxZ += 1),
            (l.ui.dialog.overlay.maxZ = l.ui.dialog.maxZ),
            this.overlay.$el.css("z-index", l.ui.dialog.overlay.maxZ)),
          (i = {
    ...
    open: function () {
      ...
      if (!this._isOpen)
        return (
          ...
          t.show(i.show),
          (this.overlay = i.modal ? new l.ui.dialog.overlay(this) : null),
          this.moveToTop(!0),
          (i =
            (i = this.element.find(":tabbable")).length ||
            (i = this.uiDialogButtonPane.find(":tabbable")).length
              ? i
              : t)
            .eq(0)
            .focus(),
        ...
        t
          ? (l.each(i, function (i, t) {
              ...
              (t = l.isFunction(t) ? { click: t, text: i } : t),
                ...
                (i = l("<button></button>", t).appendTo(o.uiButtonSet)),
    ...
    _makeDraggable: function () {
      ...
      this.uiDialog.draggable({
        ...
        start: function (i, t) {
          l(this).addClass("ui-dialog-dragging"),
            e._trigger("dragStart", i, s(t));
        },
        drag: function (i, t) {
          e._trigger("drag", i, s(t));
        },
        stop: function (i, t) {
          (o.position = [
            t.position.left - e.document.scrollLeft(),
            t.position.top - e.document.scrollTop(),
          ]),
            l(this).removeClass("ui-dialog-dragging"),
            e._trigger("dragStop", i, s(t)),
            l.ui.dialog.overlay.resize();
        },
      });
    },
    _makeResizable: function (i) {
      ...
      this.uiDialog
        .resizable({
          ...
          handles: i,
          start: function (i, t) {
            l(this).addClass("ui-dialog-resizing"),
              e._trigger("resizeStart", i, s(t));
          },
          resize: function (i, t) {
            e._trigger("resize", i, s(t));
          },
          stop: function (i, t) {
            l(this).removeClass("ui-dialog-resizing"),
              (o.height = l(this).height()),
              (o.width = l(this).width()),
              e._trigger("resizeStop", i, s(t)),
              l.ui.dialog.overlay.resize();
          },
        })
        .css("position", t)
    ...
    _position: function (i) {
      ...
      (i = i
        ? (("string" == typeof i || ("object" == typeof i && "0" in i)) &&
            (1 === (e = i.split ? i.split(" ") : [i[0], i[1]]).length &&
              (e[1] = e[0]),
            l.each(["left", "top"], function (i, t) {
              +e[i] === e[i] && ((o[i] = e[i]), (e[i] = t));
            }),
            (i = {
              my:
                e[0] +
          ...
          l.extend({}, l.ui.dialog.prototype.options.position, i))
        : l.ui.dialog.prototype.options.position),
    ...
    _setOptions: function (i) {
      var e = this,
        ...
        s = !1;
      l.each(i, function (i, t) {
        e._setOption(i, t), i in n && (s = !0), i in a && (o[i] = t);
      }),
        s && this._size(),
    ...
    _setOption: function (i, t) {
      ...
      switch (i) {
        ...
        case "closeText":
          ...
          break;
        case "dialogClass":
          o.removeClass(this.options.dialogClass).addClass(h + t);
          break;
        case "disabled":
          t
          ...
          break;
        case "draggable":
          (e = o.is(":data(draggable)")) && !t && o.draggable("destroy"),
        ...
        case "position":
          ...
          break;
        case "resizable":
          (e = o.is(":data(resizable)")) && !t && o.resizable("destroy"),
            e && "string" == typeof t && o.resizable("option", "handles", t),
            e || !1 === t || this._makeResizable(t);
          break;
        case "title":
          l(".ui-dialog-title", this.uiDialogTitlebar).html(
            "" + (t || "&#160;")
          );
      }
      this._super(i, t);
    ...
    _size: function () {
      ...
      this.element.show().css({ width: "auto", minHeight: 0, height: 0 }),
        ...
        "auto" === o.height
          ? l.support.minHeight
            ? this.element.css({ minHeight: t, height: "auto" })
            : (this.uiDialog.show(),
              (e = this.element.css("height", "auto").height()),
              s || this.uiDialog.hide(),
              this.element.height(Math.max(e, t)))
          : this.element.height(Math.max(o.height - i, 0)),
        this.uiDialog.is(":data(resizable)") &&
    ...
    l.extend(l.ui.dialog, {
      ...
      getTitleId: function (i) {
        i = i.attr("id");
        return i || ((this.uuid += 1), (i = this.uuid)), "ui-dialog-title-" + i;
      },
      overlay: function (i) {
    ...
    l.extend(l.ui.dialog.overlay, {
      ...
      create: function (e) {
        ...
        return (
          ...
          l.fn.bgiframe && o.bgiframe(),
          this.instances.push(o),
          o
        );
      },
      destroy: function (i) {
        var t = l.inArray(i, this.instances),
          e = 0;
        -1 !== t && this.oldInstances.push(this.instances.splice(t, 1)[0]),
          0 === this.instances.length &&
            l([document, window]).unbind(".dialog-overlay"),
          i.height(0).width(0).remove(),
...
!(function (r) {
  ...
  r.widget("ui.menu", {
      ...
      (this.activeMenu = this.element),
        ...
        this._on({
          ...
          "click .ui-menu-item:has(a)": function (e) {
            var t = r(e.target).closest(".ui-menu-item");
            !i &&
        ...
        this._on(this.document, {
          click: function (e) {
            r(e.target).closest(".ui-menu").length || this.collapseAll(e),
              (i = !1);
          },
        });
    },
        ...
        default:
          (a = !1),
            ...
            (t = this.activeMenu.children(".ui-menu-item").filter(function () {
              return n.test(r(this).children("a").text());
            })),
            (t =
    ...
    _scrollIntoView: function (e) {
      var t, i, s;
      this._hasScroll() &&
        ((t = parseFloat(r.css(this.activeMenu[0], "borderTopWidth")) || 0),
    ...
    _open: function (e) {
      var t = r.extend({ of: this.active }, this.options.position);
      clearTimeout(this.timer),
        this.element
          .find(".ui-menu")
    ...
    collapseAll: function (t, i) {
      clearTimeout(this.timer),
        (this.timer = this._delay(function () {
          var e = i
            ? this.element
            : r(t && t.target).closest(this.element.find(".ui-menu"));
          ...
          (this._hasScroll()
            ? ((i = this.active.offset().top),
              ...
              this.active.nextAll(".ui-menu-item").each(function () {
                return (t = r(this)).offset().top - i - s < 0;
              }),
              this.focus(e, t))
            : this.focus(
                e,
          ...
          (this._hasScroll()
            ? ((i = this.active.offset().top),
              ...
              this.active.prevAll(".ui-menu-item").each(function () {
                return 0 < (t = r(this)).offset().top - i + s;
              }),
              this.focus(e, t))
  ...
  r.widget("ui.slider", r.ui.mouse, {
    ...
    _trimAlignValue: function (e) {
      ...
      return e <= this._valueMin()
        ...
        : e >= this._valueMax()
        ? this._valueMax()
        : ((i = 0 < this.options.step ? this.options.step : 1),
          (t = e - (e = (e - this._valueMin()) % i)),
          2 * Math.abs(e) >= i && (t += 0 < e ? i : -i),
  ...
  o.widget("ui.spinner", {
    ...
    _spin: function (t, i) {
      ...
      this.counter || (this.counter = 1),
        ...
        (this.spinning && !1 === this._trigger("spin", i, { value: e })) ||
    ...
    _adjustValue: function (t) {
      var i = this.options,
        e = null !== i.min ? i.min : 0,
        n = t - e;
      return (
        (t = e + Math.round(n / i.step) * i.step),
    ...
    _setOption: function (t, i) {
      ...
      "culture" === t || "numberFormat" === t
        ? ((e = this._parse(this.element.val())),
          (this.options[t] = i),
    ...
    _value: function (t, i) {
      var e;
      "" !== t &&
        null !== (e = this._parse(t)) &&
        (i || (e = this._adjustValue(e)), (t = this._format(e))),
        this.element.val(t),
        this._refresh();
    },
    _destroy: function () {
  ...
  h.widget("ui.tabs", {
    ...
    _create: function () {
      ...
      (this.running = !1),
        ...
        !t.collapsible &&
          ...
          this.anchors.length &&
          (t.active = 0),
        h.isArray(t.disabled) &&
          (t.disabled = h
            .unique(
              t.disabled.concat(
                h.map(this.tabs.filter(".ui-state-disabled"), function (t) {
    ...
    _panelKeydown: function (t) {
      this._handlePageNav(t) ||
        (t.ctrlKey &&
          t.keyCode === h.ui.keyCode.UP &&
          (t.preventDefault(), this.active.focus()));
    },
    _handlePageNav: function (t) {
      return t.altKey && t.keyCode === h.ui.keyCode.PAGE_UP
        ? (this._activate(this._focusNextTab(this.options.active - 1, !1)), !0)
        : t.altKey && t.keyCode === h.ui.keyCode.PAGE_DOWN
    ...
    _findNextTab: function (t, e) {
      ...
      for (
        ;
        -1 !==
        h.inArray((t = (t = i < t ? 0 : t) < 0 ? i : t), this.options.disabled);
    ...
    refresh: function () {
      ...
      (t.disabled = h.map(e.filter(".ui-state-disabled"), function (t) {
        ...
        !1 !== t.active && this.anchors.length
          ? this.active.length && !h.contains(this.tablist[0], this.active[0])
            ? this.tabs.length === t.disabled.length
              ? ((t.active = !1), (this.active = h()))
    ...
    _processTabs: function () {
      ...
      (this.tablist = this._getList()
        ...
        this.anchors.each(function (t, e) {
          var i,
            s,
            a = h(e).uniqueId().attr("id"),
            n = h(e).closest("li"),
            o = n.attr("aria-controls");
          l(e)
            ? ((i = e.hash), (s = r.element.find(r._sanitizeSelector(i))))
            : ((e = r._tabId(n)),
              (s = r.element.find((i = "#" + e))).length ||
                (s = r._createPanel(e)).insertAfter(
                  r.panels[t - 1] || r.tablist
                ),
              s.attr("aria-live", "polite")),
            s.length && (r.panels = r.panels.add(s)),
            o && n.data("ui-tabs-aria-controls", o),
            n.attr({ "aria-controls": i.substring(1), "aria-labelledby": a }),
    ...
    _setupDisabled: function (t) {
      ...
      for (var e, i = 0; (e = this.tabs[i]); i++)
        !0 === t || -1 !== h.inArray(i, t)
          ? h(e).addClass("ui-state-disabled").attr("aria-disabled", "true")
          : h(e).removeClass("ui-state-disabled").removeAttr("aria-disabled");
    ...
    _setupHeightStyle: function (t) {
      ...
      "fill" === t
        ? (h.support.minHeight ||
            ((e = s.css("overflow")), s.css("overflow", "hidden")),
          (i = s.height()),
          this.element.siblings(":visible").each(function () {
            var t = h(this),
              e = t.css("position");
          ...
          this.panels
            .each(function () {
              h(this).height(
                Math.max(0, i - h(this).innerHeight() + h(this).height())
              );
            })
            .css("overflow", "auto"))
        : "auto" === t &&
    ...
    _eventHandler: function (t) {
      var e = this.options,
        ...
        a = s[0] === i[0],
        n = a && e.collapsible,
        o = n ? h() : this._getPanelForTab(s),
        r = i.length ? this._getPanelForTab(i) : h(),
        i = { oldTab: i, oldPanel: r, newTab: n ? h() : s, newPanel: o };
      t.preventDefault(),
        s.hasClass("ui-state-disabled") ||
          ...
          r.length ||
            o.length ||
            h.error("jQuery UI Tabs: Mismatching fragment identifier."),
    ...
    load: function (t, e) {
      ...
      var i = this,
        s = this.tabs.eq(t),
        t = s.find(".ui-tabs-anchor"),
        a = this._getPanelForTab(s),
        n = { tab: s, panel: a };
      l(t[0]) ||
        ((this.xhr = h.ajax(this._ajaxSettings(t, e, n))),
        this.xhr &&
      ...
      return {
        ...
        beforeSend: function (t, e) {
          return a._trigger(
            "beforeLoad",
            i,
            h.extend({ jqXHR: t, ajaxSettings: e }, s)
          );
        },
      };
    },
    _getPanelForTab: function (t) {
      t = h(t).attr("aria-controls");
      return this.element.find(this._sanitizeSelector("#" + t));
    },
  }),
    !1 !== h.uiBackCompat &&
      ((h.ui.tabs.prototype._ui = function (t, e) {
      ...
      h.widget("ui.tabs", h.ui.tabs, {
        ...
        _create: function () {
          ...
          this._on({
            tabsbeforeload: function (t, e) {
              h.data(e.tab[0], "cache.tabs")
                ? t.preventDefault()
                : e.jqXHR.success(function () {
                    i.options.cache && h.data(e.tab[0], "cache.tabs", !0);
                  });
            },
          });
        },
        ...
        _setOption: function (t, e) {
          "cache" === t && !1 === e && this.anchors.removeData("cache.tabs"),
            this._super(t, e);
        },
        _destroy: function () {
      ...
      h.widget("ui.tabs", h.ui.tabs, {
        ...
        enable: function (t) {
          var e,
            i = this.options;
          ((t && !0 === i.disabled) ||
            (h.isArray(i.disabled) && -1 !== h.inArray(t, i.disabled))) &&
            (e = !0),
            this._superApply(arguments),
            e &&
              this._trigger(
      ...
      h.widget("ui.tabs", h.ui.tabs, {
        ...
        add: function (t, e, i) {
          ...
          var s,
            ...
            t = t.indexOf("#") ? this._tabId(e) : t.replace("#", "");
          return (
            e
              .addClass("ui-state-default ui-corner-top")
              .data("ui-tabs-destroy", !0),
            ...
            (a = this.element.find("#" + t)).length ||
              ((a = this._createPanel(t)),
              s
                ? 0 < i
                  ? a.insertAfter(this.panels.eq(-1))
                  : a.appendTo(this.element)
                : a.insertBefore(this.panels[i])),
            a
              .addClass("ui-tabs-panel ui-widget-content ui-corner-bottom")
              .hide(),
            s ? e.appendTo(this.tablist) : e.insertBefore(this.tabs[i]),
            (n.disabled = h.map(n.disabled, function (t) {
              return i <= t ? ++t : t;
            })),
            this.refresh(),
            1 === this.tabs.length &&
      ...
      h.widget("ui.tabs", h.ui.tabs, {
        ...
        _tabId: function (t) {
          t = (t = t.is("li") ? t.find("a[href]") : t)[0];
          return (
            h(t).closest("li").attr("aria-controls") ||
            (t.title &&
              t.title
                .replace(/\s/g, "_")
                .replace(/[^\w\u00c0-\uFFFF\-]/g, "")) ||
      ...
      h.widget("ui.tabs", h.ui.tabs, {
        ...
        _createPanel: function (t) {
          return h(this.options.panelTemplate)
            .attr("id", t)
            .addClass("ui-tabs-panel ui-widget-content ui-corner-bottom")
            .data("ui-tabs-destroy", !0);
        },
          ...
          return (
            ...
            ("beforeActivate" === t
              ? ((s = i.newTab.length ? i.newTab : i.oldTab),
                (a = i.newPanel.length ? i.newPanel : i.oldPanel),
                (n = this._super("select", e, {
      ...
      h.widget("ui.tabs", h.ui.tabs, {
        ...
        _cookie: function (t) {
          ...
          return (
            arguments.length &&
              (e.push(!1 === t ? -1 : t), e.push(this.options.cookie)),
            h.cookie.apply(null, e)
          );
        },
        _refresh: function () {
          this._super(),
      ...
      h.widget("ui.tabs", h.ui.tabs, {
        ...
        _getFx: function () {
          var t,
            ...
            i = this.options.fx;
          return (
            i && (h.isArray(i) ? ((t = i[0]), (e = i[1])) : (t = e = i)),
            i ? { show: e, hide: t } : null
          );
        },
        _toggle: function (t, e) {
          var i = this,
          ...
          function r() {
            e.newTab.closest("li").addClass("ui-tabs-active ui-state-active"),
              s.length && n.show
                ? s.animate(n.show, n.show.duration, function () {
                    o();
                  })
                : (s.show(), o());
          }
          (i.running = !0),
            a.length && n.hide
              ? a.animate(n.hide, n.hide.duration, function () {
                  e.oldTab
                    .closest("li")
                    .removeClass("ui-tabs-active ui-state-active"),
                    r();
...
!(function (u) {
  ...
  u.widget("ui.tooltip", {
    ...
    _setOption: function (t, i) {
      var e = this;
      "disabled" === t
        ? (this[i ? "_disable" : "_enable"](), (this.options[t] = i))
        : (this._super(t, i),
          "content" === t &&
            u.each(this.tooltips, function (t, i) {
              e._updateContent(i);
            }));
    },
    _disable: function () {
      ...
      u.each(this.tooltips, function (t, i) {
        var e = u.Event("blur");
        (e.target = e.currentTarget = i[0]), o.close(e, !0);
      }),
        this.element
          .find(this.options.items)
          .andSelf()
        ...
        t &&
          ...
          i.parents().each(function () {
            ...
            i.data("ui-tooltip-open") &&
              (((t = u.Event("blur")).target = t.currentTarget = this),
              e.close(t, !0)),
              i.attr("title") &&
                (i.uniqueId(),
                (e.parents[this.id] = {
    ...
    _updateContent: function (i, e) {
      var t = this.options.content,
        o = this,
        n = e ? e.type : null;
      if ("string" == typeof t) return this._open(e, i, t);
    ...
    _open: function (t, i, e) {
      ...
      function p(t) {
        (r.of = t), a.is(":hidden") || a.position(r);
      }
      e &&
        ((a = this._find(i)).length
          ? a.find(".ui-tooltip-content").html(e)
          : (i.is("[title]") &&
              (t && "mouseover" === t.type
                ? i.attr("title", "")
                : i.removeAttr("title")),
            ...
            (n = i),
            (s = a.attr("id")),
            (l = (n.attr("aria-describedby") || "").split(/\s+/)).push(s),
            n
              .data("ui-tooltip-id", s)
              .attr("aria-describedby", u.trim(l.join(" "))),
            a.find(".ui-tooltip-content").html(e),
            this.options.track && t && /^mouse/.test(t.type)
              ? (this._on(this.document, { mousemove: p }), p(t))
              : a.position(u.extend({ of: i }, this.options.position)),
            a.hide(),
            this._show(a, this.options.show),
            this.options.show &&
              this.options.show.delay &&
              (o = setInterval(function () {
                a.is(":visible") && (p(r.of), clearInterval(o));
              }, u.fx.interval)),
            this._trigger("open", t, { tooltip: a }),
            (n = {
              keyup: function (t) {
                t.keyCode === u.ui.keyCode.ESCAPE &&
                  (((t = u.Event(t)).currentTarget = i[0]), this.close(t, !0));
              },
              remove: function () {
    ...
    close: function (t) {
      ...
      this.closing ||
        ...
        t &&
          "mouseleave" === t.type &&
          u.each(this.parents, function (t, i) {
            u(i.element).attr("title", i.title), delete n.parents[t];
          }),
        (this.closing = !0),
        this._trigger("close", t, { tooltip: l }),
        (this.closing = !1));
    },
    _tooltip: function (t) {
      var i = "ui-tooltip-" + o++,
      ...
      return (
        u("<div>").addClass("ui-tooltip-content").appendTo(e),
        e.appendTo(this.document[0].body),
        u.fn.bgiframe && e.bgiframe(),
        (this.tooltips[i] = t),
        e
      );
    },
  ...
  (function (i, s) {
      ...
      return (
        ...
        m(e, function (t, e) {
          ...
          if (n)
            return (
              (n = o[e](n)),
              (o[p[e].cache] = n[p[e].cache]),
              (s = o._rgba = n._rgba),
              !1
            );
        }),
        s.length
          ? ("0,0,0,0" === s.join() && l.extend(s, c.transparent), o)
          : c[r]
      );
    }
    function C(t, e, n) {
    ...
    function _() {
      ...
      if (n && n.length && n[0] && n[n[0]])
        for (e = n.length; e--; )
          "string" == typeof n[(t = n[e])] && (r[i.camelCase(t)] = n[t]);
      else for (t in n) "string" == typeof n[t] && (r[t] = n[t]);
      return r;
    }
    function w(t, e, n, r) {
      return (
        (t = { effect: (t = i.isPlainObject(t) ? (e = t).effect : t) }),
        i.isFunction((e = null == e ? {} : e)) &&
          ((r = e), (n = null), (e = {})),
        ("number" != typeof e && !i.fx.speeds[e]) ||
          ((r = n), (n = e), (e = {})),
        i.isFunction(n) && ((r = n), (n = null)),
        e && i.extend(t, e),
        (n = n || e.duration),
        (t.duration = i.fx.off
          ? 0
    ...
    function k(t) {
      return !(
        ...
        "number" != typeof t &&
        !i.fx.speeds[t] &&
        ("string" != typeof t || i.effects.effect[t] || (o && i.effects[t]))
      );
    }
    (i.effects = { effect: {} }),
      (l = jQuery),
      ...
      (a.rgba = -1 < n.style.backgroundColor.indexOf("rgba")),
      m(p, function (t, e) {
        (e.cache = "_" + t),
      ...
      ((h.fn = l.extend(h.prototype, {
        parse: function (o, t, e, n) {
          ...
          var s = this,
            ...
            a = (this._rgba = []);
          return (
            t !== u && ((o = [o, t, e, n]), (r = "array")),
            "string" === r
              ? this.parse(x(o) || c._default)
              : "array" === r
              ...
              ? (o instanceof h
                  ? m(p, function (t, e) {
                      o[e.cache] && (s[e.cache] = o[e.cache].slice());
                    })
                  : m(p, function (t, n) {
                      var r = n.cache;
                      m(n.props, function (t, e) {
                        ...
                        s[r] &&
                          i.inArray(null, s[r].slice(0, 3)) < 0 &&
                          ((s[r][3] = 1), n.from) &&
                          (s._rgba = n.from(s[r]));
                    }),
                this)
              ...
              return (
                r &&
                  ...
                  m(e.props, function (t, e) {
                    if (null != r[e.idx]) return (s = r[e.idx] === n[e.idx]);
                  })),
                s
              );
            }),
      ...
      (p.hsla.to = function (t) {
        ...
        return null == t[0] || null == t[1] || null == t[2]
          ...
          : ((r = t[0] / 255),
            ...
            (s = t[2] / 255),
            (t = t[3]),
            (n = (a = Math.max(r, o, s)) - (e = Math.min(r, o, s))),
            (s =
              e === a
                ? 0
                : r === a
            ...
            (a =
              0 == (o = 0.5 * (r = a + e)) || 1 == o
                ...
                ? n / r
                : n / (2 - r)),
            [Math.round(s) % 360, a, o, null == t ? 1 : t]);
      }),
      (p.hsla.from = function (t) {
        ...
        return null == t[0] || null == t[1] || null == t[2]
          ...
          : ((e = t[0] / 360),
            ...
            [
              Math.round(255 * C(r, n, e + 1 / 3)),
              Math.round(255 * C(r, n, e)),
              Math.round(255 * C(r, n, e - 1 / 3)),
              t,
            ]);
      }),
        ...
        (h.fn[i] = function (t) {
            ...
            t === u
              ...
              : ((n = l.type(t)),
                ...
                m(s, function (t, e) {
                  ...
                  null == t && (t = o[e.idx]), (o[e.idx] = v(t, e));
                }),
                f ? (((e = h(f(o)))[a] = o), e) : h(o))
          );
        }),
          m(s, function (s, a) {
            h.fn[s] ||
              (h.fn[s] = function (t) {
                var e = l.type(t),
                  n = "alpha" === s ? (this._hsla ? "hsla" : "rgba") : i,
                  r = this[n](),
                  o = r[a.idx];
                return "undefined" === e
                  ? o
                  : ("function" === e &&
                      ((t = t.call(this, o)), (e = l.type(t))),
                    null == t && a.empty
                      ? this
                      : ("string" === e &&
                          (e = d.exec(t)) &&
        ...
        (l.cssHooks[s] = {
          set: function (t, e) {
            var n,
              r,
              o = "";
            if ("string" !== l.type(e) || (n = x(e))) {
              if (((e = h(n || e)), !a.rgba && 1 !== e._rgba[3])) {
                for (
                  r = "backgroundColor" === s ? t.parentNode : t;
                  ("" === o || "transparent" === o) && r && r.style;

                )
                  try {
                    (o = l.css(r, "backgroundColor")), (r = r.parentNode);
                  } catch (t) {}
          ...
          (l.fx.step[s] = function (t) {
            t.colorInit ||
              ((t.start = h(t.elem, s)),
              (t.end = h(t.end)),
              (t.colorInit = !0)),
              l.cssHooks[s].set(t.elem, t.start.transition(t.end, t.pos));
          });
      }),
      ...
      (i.effects.animateClass = function (o, t, e, n) {
        var s = i.speed(t, e, n);
        return this.queue(function () {
          var n = i(this),
            t = n.attr("class") || "",
            e = (e = s.children ? n.find("*").andSelf() : n).map(function () {
              return { el: i(this), start: _.call(this) };
            }),
            r = function () {
          ...
          r(),
                ...
                (this.diff = (function (t, e) {
                  ...
                  for (n in e)
                    (r = e[n]),
                      t[n] === r ||
                        b[n] ||
                        (!i.fx.step[n] && isNaN(parseFloat(r))) ||
                        (o[n] = r);
                  return o;
                })(this.start, this.end)),
                this
            ...
            i.when.apply(i, e.get()).done(function () {
              r(),
      ...
      i.fn.extend({
        ...
        addClass: function (t, e, n, r) {
          return e
            ? i.effects.animateClass.call(this, { add: t }, e, n, r)
            : this._addClass(t);
        },
        _removeClass: i.fn.removeClass,
        removeClass: function (t, e, n, r) {
          return e
            ? i.effects.animateClass.call(this, { remove: t }, e, n, r)
            : this._removeClass(t);
        },
        _toggleClass: i.fn.toggleClass,
        toggleClass: function (t, e, n, r, o) {
          return "boolean" == typeof e || e === s
            ? n
              ? i.effects.animateClass.call(
                  this,
                  e ? { add: t } : { remove: t },
                  n,
                  r,
            ...
            : i.effects.animateClass.call(this, { toggle: t }, e, n, r);
        },
        switchClass: function (t, e, n, r, o) {
          return i.effects.animateClass.call(
            this,
            { add: e, remove: t },
            n,
            r,
      ...
      i.extend(i.effects, {
        ...
        save: function (t, e) {
          for (var n = 0; n < e.length; n++)
            null !== e[n] && t.data(y + e[n], t[0].style[e[n]]);
        },
        restore: function (t, e) {
          for (var n, r = 0; r < e.length; r++)
            null !== e[r] &&
              ((n = t.data(y + e[r])) === s && (n = ""), t.css(e[r], n));
        },
        ...
        createWrapper: function (n) {
          ...
          return (
            n.wrap(t),
            (n[0] !== o && !i.contains(n[0], o)) || i(o).focus(),
            (t = n.parent()),
        ...
        setTransition: function (r, t, o, s) {
          return (
            (s = s || {}),
      ...
      i.fn.extend({
        effect: function () {
          var s = w.apply(this, arguments),
            t = s.mode,
            e = s.queue,
            a = i.effects.effect[s.effect],
            n = !a && o && i.effects[s.effect];
          return i.fx.off || (!a && !n)
            ? t
              ? this[t](s.duration, s.complete)
              : this.each(function () {
          ...
          function r(t) {
            var e = i(this),
              ...
              r = s.mode;
            function o() {
              i.isFunction(n) && n.call(e[0]), i.isFunction(t) && t();
            }
        ...
        show: function (t) {
          ...
          return k(t)
            ...
            : (((e = w.apply(this, arguments)).mode = "show"),
        ...
        hide: function (t) {
          ...
          return k(t)
            ...
            : (((e = w.apply(this, arguments)).mode = "hide"),
              this.effect.call(this, e));
        },
        __toggle: i.fn.toggle,
        toggle: function (t) {
          var e;
          return k(t) || "boolean" == typeof t || i.isFunction(t)
            ? this.__toggle.apply(this, arguments)
            : (((e = w.apply(this, arguments)).mode = "toggle"),
              this.effect.call(this, e));
        },
        cssUnit: function (t) {
          var n = this.css(t),
...
!(function (l) {
  var v = /up|down|vertical/,
    w = /up|left|vertical|horizontal/;
  l.effects.effect.blind = function (e, t) {
    var s,
      o,
      i,
      f = l(this),
      r = ["position", "top", "bottom", "left", "right", "height", "width"],
      c = l.effects.setMode(f, e.mode || "hide"),
      a = e.direction || "up",
      n = v.test(a),
      p = n ? "height" : "width",
      h = n ? "top" : "left",
    ...
    f.parent().is(".ui-effects-wrapper")
      ? l.effects.save(f.parent(), r)
      : l.effects.save(f, r),
      f.show(),
      (o = (s = l.effects.createWrapper(f).css({ overflow: "hidden" }))[p]()),
      (i = parseFloat(s.css(h)) || 0),
      (d[p] = u ? o : 0),
      a ||
        (f
          .css(n ? "bottom" : "right", 0)
          .css(n ? "top" : "left", "auto")
          .css({ position: "absolute" }),
        (d[h] = u ? i : o + i)),
      u && (s.css(p, 0), a || s.css(h, i + o)),
      s.animate(d, {
        duration: e.duration,
        easing: e.easing,
        queue: !1,
        complete: function () {
          "hide" === c && f.hide(),
            l.effects.restore(f, r),
            l.effects.removeWrapper(f),
            t();
        },
      });
  };
...
!(function (g) {
  g.effects.effect.bounce = function (e, t) {
    var i,
      o,
      c,
      a = g(this),
      f = ["position", "top", "bottom", "left", "right", "height", "width"],
      s = g.effects.setMode(a, e.mode || "effect"),
      p = "hide" === s,
      s = "show" === s,
      n = e.direction || "up",
      u = e.distance,
    ...
    for (
      (s || p) && f.push("opacity"),
        g.effects.save(a, f),
        a.show(),
        g.effects.createWrapper(a),
        u = u || a["top" == l ? "outerHeight" : "outerWidth"]() / 3,
        s &&
          (((c = { opacity: 1 })[l] = 0),
          a
            .css("opacity", 0)
      ...
      ((o = {})[l] = (y ? "-=" : "+=") + u),
        a.animate(o, d, m).animate(c, d, m),
        (u = p ? 2 * u : u / 2);
    p &&
      (((o = { opacity: 0 })[l] = (y ? "-=" : "+=") + u), a.animate(o, d, m)),
      a.queue(function () {
        p && a.hide(), g.effects.restore(a, f), g.effects.removeWrapper(a), t();
      }),
      1 < n && e.splice.apply(e, [1, 0].concat(e.splice(n, 1 + h))),
      a.dequeue();
  };
})(jQuery);
!(function (h) {
  h.effects.effect.clip = function (e, t) {
    var i,
      o,
      s = h(this),
      f = ["position", "top", "bottom", "left", "right", "height", "width"],
      c = "show" === h.effects.setMode(s, e.mode || "hide"),
    ...
    h.effects.save(s, f),
      s.show(),
      (i = h.effects.createWrapper(s).css({ overflow: "hidden" })),
      (o = (i = "IMG" === s[0].tagName ? i : s)[a]()),
      c && (i.css(a, 0), i.css(r, o / 2)),
      (n[a] = c ? o : 0),
      (n[r] = c ? 0 : o / 2),
      i.animate(n, {
        queue: !1,
        ...
        complete: function () {
          c || s.hide(),
            h.effects.restore(s, f),
            h.effects.removeWrapper(s),
            t();
        },
      });
  };
...
!(function (a) {
  a.effects.effect.drop = function (e, t) {
    var o,
      i = a(this),
      s = [
        "position",
      ...
      f = a.effects.setMode(i, e.mode || "hide"),
      c = "show" === f,
      p = e.direction || "left",
      r = "up" === p || "down" === p ? "top" : "left",
      p = "up" === p || "left" === p ? "pos" : "neg",
      n = { opacity: c ? 1 : 0 };
    a.effects.save(i, s),
      i.show(),
      a.effects.createWrapper(i),
      (o = e.distance || i["top" == r ? "outerHeight" : "outerWidth"](!0) / 2),
      c && i.css("opacity", 0).css(r, "pos" == p ? -o : o),
      (n[r] = (c ? ("pos" == p ? "+=" : "-=") : "pos" == p ? "-=" : "+=") + o),
      i.animate(n, {
        queue: !1,
        duration: e.duration,
...
!(function (y) {
  y.effects.effect.explode = function (e, i) {
    var t,
      o,
      s,
      d,
      ...
      a = l,
      c = y(this),
      n = "show" === y.effects.setMode(c, e.mode || "hide"),
      p = c.show().css("visibility", "hidden").offset(),
      r = Math.ceil(c.outerWidth() / a),
      u = Math.ceil(c.outerHeight() / l),
      v = [];
    function b() {
      v.push(this),
        v.length === l * a &&
          (c.css({ visibility: "visible" }), y(v).remove(), n || c.hide(), i());
    }
    for (t = 0; t < l; t++)
      for (d = p.top + t * u, h = t - (l - 1) / 2, o = 0; o < a; o++)
        (s = p.left + o * r),
          (f = o - (a - 1) / 2),
          c
            .clone()
...
!(function (i) {
  i.effects.effect.fade = function (e, t) {
    var a = i(this),
      f = i.effects.setMode(a, e.mode || "toggle");
    a.animate(
      { opacity: f },
...
!(function (m) {
  m.effects.effect.fold = function (e, t) {
    var i,
      h = m(this),
      s = ["position", "top", "bottom", "left", "right", "height", "width"],
      f = m.effects.setMode(h, e.mode || "hide"),
      o = "show" === f,
      d = "hide" === f,
      f = e.size || 15,
      r = /([0-9]+)%/.exec(f),
      c = !!e.horizFirst,
      n = o != c,
      a = n ? ["width", "height"] : ["height", "width"],
      g = e.duration / 2,
      w = {},
      p = {};
    m.effects.save(h, s),
      h.show(),
      (i = m.effects.createWrapper(h).css({ overflow: "hidden" })),
      (n = n ? [i.width(), i.height()] : [i.height(), i.width()]),
      r && (f = (parseInt(r[1], 10) / 100) * n[d ? 0 : 1]),
      o && i.css(c ? { height: 0, width: f } : { height: f, width: 0 }),
      (w[a[0]] = o ? n[0] : f),
      (p[a[1]] = o ? n[1] : 0),
      i.animate(w, g, e.easing).animate(p, g, e.easing, function () {
        d && h.hide(), m.effects.restore(h, s), m.effects.removeWrapper(h), t();
      });
  };
})(jQuery);
!(function (f) {
  f.effects.effect.highlight = function (e, o) {
    var c = f(this),
      n = ["backgroundImage", "backgroundColor", "opacity"],
      a = f.effects.setMode(c, e.mode || "show"),
      t = { backgroundColor: c.css("backgroundColor") };
    "hide" === a && (t.opacity = 0),
      f.effects.save(c, n),
      c
        .show()
        ...
        .animate(t, {
          ...
          easing: e.easing,
          complete: function () {
            "hide" === a && c.hide(), f.effects.restore(c, n), o();
          },
        });
  };
})(jQuery);
!(function (p) {
  p.effects.effect.pulsate = function (e, i) {
    var t,
      s = p(this),
      a = p.effects.setMode(s, e.mode || "show"),
      c = "show" === a,
      o = "hide" === a,
      n = 2 * (e.times || 5) + (c || "hide" === a ? 1 : 0),
      u = e.duration / n,
      f = 0,
      a = s.queue(),
      h = a.length;
    for (
      (!c && s.is(":visible")) || (s.css("opacity", 0).show(), (f = 1)), t = 1;
      t < n;
      t++
    )
      s.animate({ opacity: f }, u, e.easing), (f = 1 - f);
    s.animate({ opacity: f }, u, e.easing),
      s.queue(function () {
        o && s.hide(), i();
      }),
      1 < h && a.splice.apply(a, [1, 0].concat(a.splice(h, 1 + n))),
      s.dequeue();
  };
})(jQuery);
!(function (y) {
  (y.effects.effect.puff = function (t, e) {
    var o = y(this),
      i = y.effects.setMode(o, t.mode || "hide"),
      r = "hide" === i,
      f = parseInt(t.percent, 10) || 150,
      h = f / 100,
      c = {
        height: o.height(),
        width: o.width(),
    ...
    (y.effects.effect.scale = function (t, e) {
      var o = y(this),
        ...
        f =
          ...
          (0 === parseInt(t.percent, 10) || "hide" === r ? 0 : 100),
        h = t.direction || "both",
        c = t.origin,
        s = {
          height: o.height(),
        ...
        n = "horizontal" !== h ? f / 100 : 1,
        h = "vertical" !== h ? f / 100 : 1;
      (i.effect = "size"),
        (i.queue = !1),
        (i.complete = e),
        "effect" !== r &&
          ((i.origin = c || ["middle", "center"]), (i.restore = !0)),
        (i.from =
          t.from ||
          ("show" === r
        ...
        (i.to = {
          height: s.height * n,
          width: s.width * h,
          outerHeight: s.outerHeight * n,
          outerWidth: s.outerWidth * h,
        }),
        i.fade &&
          ("show" === r && ((i.from.opacity = 0), (i.to.opacity = 1)),
          "hide" === r) &&
          ((i.from.opacity = 1), (i.to.opacity = 0)),
        o.effect(i);
    }),
    (y.effects.effect.size = function (f, t) {
      var e,
        h,
        c = y(this),
        o = [
        ...
        r = y.effects.setMode(c, f.mode || "effect"),
        a = f.restore || "effect" !== r,
        m = f.scale || "both",
      ...
      "show" === r && c.show(),
        ...
        "toggle" === f.mode && "show" === r
          ? ((c.from = f.to || w), (c.to = f.from || e))
          : ((c.from = f.from || ("show" === r ? w : e)),
            (c.to = f.to || ("hide" === r ? w : e))),
        (h = {
          from: { y: c.from.height / e.height, x: c.from.width / e.width },
          to: { y: c.to.height / e.height, x: c.to.width / e.width },
        }),
        ("box" !== m && "both" !== m) ||
          (h.from.y !== h.to.y &&
            ((p = p.concat(n)),
            (c.from = y.effects.setTransition(c, n, h.from.y, c.from)),
            (c.to = y.effects.setTransition(c, n, h.to.y, c.to))),
          h.from.x !== h.to.x &&
            ((p = p.concat(d)),
            (c.from = y.effects.setTransition(c, d, h.from.x, c.from)),
            (c.to = y.effects.setTransition(c, d, h.to.x, c.to)))),
        ("content" !== m && "both" !== m) ||
          (h.from.y !== h.to.y &&
            ((p = p.concat(i).concat(s)),
            (c.from = y.effects.setTransition(c, i, h.from.y, c.from)),
            (c.to = y.effects.setTransition(c, i, h.to.y, c.to)))),
        y.effects.save(c, p),
        c.show(),
        y.effects.createWrapper(c),
        c.css("overflow", "hidden").css(c.from),
        g &&
          ((w = y.effects.getBaseline(g, e)),
          (c.from.top = (e.outerHeight - c.outerHeight()) * w.y),
          (c.from.left = (e.outerWidth - c.outerWidth()) * w.x),
          (c.to.top = (e.outerHeight - c.to.outerHeight) * w.y),
          (c.to.left = (e.outerWidth - c.to.outerWidth) * w.x)),
        c.css(c.from),
        ("content" !== m && "both" !== m) ||
          ((n = n.concat(["marginTop", "marginBottom"]).concat(i)),
          (d = d.concat(["marginLeft", "marginRight"])),
          (s = o.concat(n).concat(d)),
          c.find("*[width]").each(function () {
            var t = y(this),
              ...
              i = t.outerHeight(),
              r = t.outerWidth();
            a && y.effects.save(t, s),
              (t.from = {
                height: e * h.from.y,
                width: o * h.from.x,
                outerHeight: i * h.from.y,
                outerWidth: r * h.from.x,
              }),
              (t.to = {
                height: e * h.to.y,
                width: o * h.to.x,
                outerHeight: e * h.to.y,
                outerWidth: o * h.to.x,
              }),
              h.from.y !== h.to.y &&
                ((t.from = y.effects.setTransition(t, n, h.from.y, t.from)),
                (t.to = y.effects.setTransition(t, n, h.to.y, t.to))),
              h.from.x !== h.to.x &&
                ((t.from = y.effects.setTransition(t, d, h.from.x, t.from)),
                (t.to = y.effects.setTransition(t, d, h.to.x, t.to))),
              t.css(t.from),
              t.animate(t.to, f.duration, f.easing, function () {
                a && y.effects.restore(t, s);
              });
          })),
        c.animate(c.to, {
          queue: !1,
            ...
            0 === c.to.opacity && c.css("opacity", c.from.opacity),
              ...
              a ||
                ("static" === u
                  ...
                  : y.each(["top", "left"], function (r, t) {
                      c.css(t, function (t, e) {
                        var o = parseInt(e, 10),
                          i = r ? c.to.left : c.to.top;
                        return "auto" === e ? i + "px" : o + i + "px";
                      });
                    })),
              y.effects.removeWrapper(c),
              t();
          },
        });
    });
...
!(function (q) {
  q.effects.effect.shake = function (e, t) {
    var i,
      a = q(this),
      f = ["position", "top", "bottom", "left", "right", "height", "width"],
      n = q.effects.setMode(a, e.mode || "effect"),
      s = e.direction || "left",
      o = e.distance || 20,
      c = e.times || 3,
      r = 2 * c + 1,
      u = Math.round(e.duration / r),
    ...
    for (
      q.effects.save(a, f),
        a.show(),
        q.effects.createWrapper(a),
        d[p] = (s ? "-=" : "+=") + o,
        h[p] = (s ? "+=" : "-=") + 2 * o,
        m[p] = (s ? "-=" : "+=") + 2 * o,
        a.animate(d, u, e.easing),
        i = 1;
      i < c;
      i++
    )
      a.animate(h, u, e.easing).animate(m, u, e.easing);
    a
      .animate(h, u, e.easing)
      .animate(d, u / 2, e.easing)
      .queue(function () {
        "hide" === n && a.hide(),
          q.effects.restore(a, f),
          q.effects.removeWrapper(a),
          t();
      }),
      1 < l && g.splice.apply(g, [1, 0].concat(g.splice(l, 1 + r))),
      a.dequeue();
  };
})(jQuery);
!(function (a) {
  a.effects.effect.slide = function (e, t) {
    var o,
      i = a(this),
      s = ["position", "top", "bottom", "left", "right", "width", "height"],
      f = a.effects.setMode(i, e.mode || "show"),
      r = "show" === f,
      c = e.direction || "left",
    ...
    a.effects.save(i, s),
      i.show(),
      (o = e.distance || i["top" == n ? "outerHeight" : "outerWidth"](!0)),
      a.effects.createWrapper(i).css({ overflow: "hidden" }),
      r && i.css(n, c ? (isNaN(o) ? "-" + o : -o) : o),
      (d[n] = (r ? (c ? "+=" : "-=") : c ? "-=" : "+=") + o),
      i.animate(d, {
        queue: !1,
        duration: e.duration,
...
!(function (r) {
  r.effects.effect.transfer = function (t, e) {
    var i = r(this),
      o = r(t.to),
      ...
      o = i.offset(),
      a = r('<div class="ui-effects-transfer"></div>')
        .appendTo(document.body)
